...
<h1 class="page-header"><i class="fas fa-envelope-open-dollar"></i> <%= GetTerm("Accounts Payable") %> Menu</h1>
	...
	<div class="row">
		<div class="col-md-12">
			<div class="menu-option">
				...
				<div class="menu-text"><a href="<%= BaseURL %>accountspayable/vendors/main.asp">Add/Edit Vendors</a></div>
			</div>
		</div>
	</div>
