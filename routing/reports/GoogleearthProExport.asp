...
<%
CreateAuditLogEntry GetTerm("Routing") & " Report",GetTerm("Routing") & " Report","Minor",0, MUV_Read("DisplayName") & " ran the report: Export Deliveries To Google Earth"
%>
...
<link href="<%= baseURL %>js/bootstrap-datepicker/css/bootstrap-datepicker.css" rel="stylesheet" type="text/css">
<script src="<%= baseURL %>js/bootstrap-datepicker/js/bootstrap-datepicker.js" type="text/javascript"></script>
...
<h3 class="page-header"><i class="fa fa-globe"></i> Export Deliveries To Google Earth &nbsp;&nbsp;
	<a href="<%= BaseURL %>routing/reports/main.asp"><button type="button" class="btn btn-primary">Back To <%= GetTerm("Routing") %> Reports List</button></a></h3>
   ...
   $(document).ready(function(){	
	...
	$("#datepicker1").datepicker()
		.on('hide', function(e) {
	        ...
	        location.href = 'GoogleearthProExport.asp?date=' + selectedDate;

	});

	$('#report_1').click(function (e) {
		location.href = 'GoogleearthProExport.asp';
	});
...
function download(filename, text) {
  ...
  function getcsvtext(objs) {
	var h1 = "";
	var csvtext = "\"Latitude\",\"Longitude\",\"Truck Number\",\"Driver Name\",\"Customer Name\",\"Address 1\",\"Address 2\",\"City State Zip\",\"Phone\",\"Contact\",\"Contact First Name\",\"Contact Last Name\",\"City\",\"State\",\"Zip\"\r\n";
...
End If
	...
	csvtext = "\""Truck Number\"",\""Driver Name\"",\""Latitude\"",\""Longitude\"",\""Customer Name\"",\""Address 1\"",\""Address 2\"",\""City\"",\""State\"",\""Zip\"",\""City State Zip\"",\""Phone\"",\""Contact\"",\""Contact First Name\"",\""Contact Last Name\""\r\n"
	kmltext = ""
	do while not rs.Eof
...
<div id="map" style="width: 48%; height: 500px;float: left;"></div><div style="width: 1%; height: 500px;float:left"></div><div id="map1" style="width: 48%; height: 500px; float: right;"></div>
	...
	<!-- API KEY WEBSITE SIDE !-->
	
  <script src="http://maps.google.com/maps/api/js?sensor=false&key=AIzaSyAraMpiqQHSizDjCHgmlB0xqmy89nJS39I" 
...
Function GetXML(addr)
  ...
  'SERVER SIDE API KEY 
  url = "https://maps.googleapis.com/maps/api/geocode/xml?address={addr}&sensor=false&key=AIzaSyC9feog3Fl9Zg1YmYbp-9HUqcfmh-hsmGA"
