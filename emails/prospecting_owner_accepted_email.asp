...
emailSubject = "MDS Insight New " & GetTerm("Prospecting") & " Prospect Owner Request Accepted"
...
emailBody =  emailBody & GetUserDisplayNameByUserNo(userNo) & " has accepted ownership of the following prospect:<br><br>"
