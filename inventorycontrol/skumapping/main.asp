...
<h1 class="page-header"><i class="fa fa-map-marker" aria-hidden="true"></i> SKU Mapping Tool</h1>
            ...
            <table    class="table table-striped table-condensed table-hover table-bordered sortable">
              <thead>
                <tr>
                  ...
                  <th>Created On</th>
                  <th># SKUs Mapped</th>
                  <th class="sorttable_nosort">Manage SKUs</th>
                </tr>
              </thead>
              <tbody class='searchable'>
				...
				If NOT rs.EOF Then
			        ...
			        %>
						<!-- table line !-->
						<tr>
							<td><a href="selectPartnerSKUCategoryToEdit.asp?i=<%= InternalRecordIdentifier %>"><%= partnerCompanyName %></a></td>
							<td><a href="selectPartnerSKUCategoryToEdit.asp?i=<%= InternalRecordIdentifier %>"><%= partnerAPIKey %></a></td>
							<td><a href="selectPartnerSKUCategoryToEdit.asp?i=<%= InternalRecordIdentifier %>"><%= RecordCreationDateTime %></a></td>
							<td><a href="selectPartnerSKUCategoryToEdit.asp?i=<%= InternalRecordIdentifier %>"><%= NumberOfSKUsDefinedForPartner(InternalRecordIdentifier) %> SKUs</a></td>	
							<td><a href="selectPartnerSKUCategoryToEdit.asp?i=<%= InternalRecordIdentifier %>"><button type="button" class="btn btn-success">MAP SKUS</button></a></td>
					   	</tr>
					<%
						rs.movenext
					Loop
