...
If InternalRecordIdentifier <> "" Then
	...
	SQLDelete = "Select * FROM EQ_Manufacturers WHERE InternalRecordIdentifier = "& InternalRecordIdentifier 
	...
	If not rsDelete.Eof Then 
		manufacturerName = rsDelete("ManufacturerName")
	End If
	...
	SQLDelete = "Delete FROM EQ_Manufacturers WHERE InternalRecordIdentifier = "& InternalRecordIdentifier 
	...
	Description = "The " & GetTerm("Equipment") & " Manufacturer, " & manufacturerName & ", was deleted by " & GetUserDisplayNameByUserNo(Session("UserNo")) 
