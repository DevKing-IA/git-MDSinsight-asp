...
<!--
    function validateEditConditionForm()
    {

        if (document.frmEditCondition.txtCondition.value == "") {
...
If not rs.EOF Then
	...
	ConditionDescription = rs("Description")
End If
set rs = Nothing
cnn8.close
set cnn8 = Nothing
...
<div class="custom-container">
	...
	<form method="POST" action="editCondition_submit.asp" name="frmEditCondition" id="frmEditCondition" onsubmit="return validateEditConditionForm();">
		...
		<div class="row row-line">
			...
			<div class="form-group col-lg-12">
    			...
    			<div class="col-sm-6">
    				<input type="text" class="form-control required" id="txtCondition" name="txtCondition" value="<%= Condition %>">
    			</div>
			</div>
		...
		<div class="row row-line">
			...
			<div class="form-group col-lg-12">
    			...
    			<div class="col-sm-6">
    				<textarea class="form-control" id="txtConditionDescription" name="txtConditionDescription"><%= ConditionDescription %></textarea>
    			</div>
			</div>
		...
		<div class="row row-line">
			<div class="col-lg-12 alertbutton">
				<div class="col-lg-12">
					<a href="<%= BaseURL %>equipment/condition/main.asp">
	    				<button type="button" class="btn btn-default">&lsaquo; Cancel &amp; Go Back To Conditions List</button>
					</a>
