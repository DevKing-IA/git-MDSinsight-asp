...
<h1 class="page-header">View Condition Details For <strong><%= GetConditionNameByIntRecID(InternalRecordIdentifier) %></strong></h1>
	...
	<div class="table-responsive">
            <table class="table table-striped table-condensed table-hover table-bordered sortable">
              ...
              <tbody class='searchable'>
				...
				SQL = SQL & " WHERE EQ_Equipment.CurrentConditionIntRecID = " & InternalRecordIdentifier & " ORDER BY ClassIntRecID"
