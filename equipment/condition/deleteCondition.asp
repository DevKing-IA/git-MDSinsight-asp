...
If InternalRecordIdentifier <> "" Then
	...
	SQLDelete = "Select * FROM EQ_Condition WHERE InternalRecordIdentifier = "& InternalRecordIdentifier 
	...
	If not rsDelete.Eof Then Condition = rsDelete("Condition")
	...
	SQLDelete = "Delete FROM EQ_Condition WHERE InternalRecordIdentifier = "& InternalRecordIdentifier 
	...
	Description = "The " & GetTerm("Equipment") & " condition named " & Condition & " was deleted by " & GetUserDisplayNameByUserNo(Session("UserNo")) 
