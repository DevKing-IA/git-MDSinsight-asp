        ...
        <div class="col-md-3">
				...
				<div class="row row-line">
					<div class="form-group col-lg-12">
		    			...
		    			<div class="col-sm-8">
		    				<input type="text" class="form-control inp" id="txtPurchasedViaPONumber" name="txtPurchasedViaPONumber" value="<%= PurchasedViaPONumber %>">
		    			</div>
					</div>
				</div>		
	    ...
	    <div class="col-md-3">
				...
				<div class="row row-line">
					<div class="form-group col-lg-12">
		    			...
		    			<div class="col-sm-8">
		    				<input type="text" class="form-control inp" id="txtColor" name="txtColor" value="<%= Color %>">
		    			</div>
					</div>
				</div>		
				...
				<div class="row row-line">
					<div class="form-group col-lg-12">
		    			...
		    			<div class="col-sm-8">
		    				<input type="text" class="form-control inp" id="txtSize" name="txtSize" value="<%= Size %>">
		    			</div>
					</div>
				</div>		
				...
				<div class="row row-line">
					<div class="form-group col-lg-12">
		    			...
		    			<div class="col-sm-8">
		    				<textarea class="form-control inp" id="txtComments" name="txtComments" rows="10"><%= Comments %></textarea>
		    			</div>
					</div>
				</div>		
