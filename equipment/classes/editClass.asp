...
<!--
    function validateEditClassForm()
    {
        ...
        if (document.frmEditClass.txtClass.value == "") {
            swal("Class cannot be blank.");
            return false;
        }
        
        if (document.frmEditClass.txtInsightAssetTagPrefix.value == "") {
...
<h1 class="page-header"> Edit <%= GetTerm("Equipment") %> Class</h1>

<div class="custom-container">

	<form method="POST" action="editClass_submit.asp" name="frmEditClass" id="frmEditClass" onsubmit="return validateEditClassForm();">
		...
		<div class="row row-line">
			...
			<div class="form-group col-lg-12">
				<label for="txtClass" class="col-sm-3 control-label">Class</label>	
    			<div class="col-sm-6">
    				<input type="text" class="form-control required" id="txtClass" name="txtClass" value="<%= EquipmentClass %>">
    			</div>
			</div>
		</div>
		...
		<div class="row row-line">
			<div class="col-lg-12 alertbutton">
				<div class="col-lg-12">
					<a href="<%= BaseURL %>equipment/classes/main.asp">
	    				<button type="button" class="btn btn-default">&lsaquo; Cancel &amp; Go Back To Class List</button>
					</a>
