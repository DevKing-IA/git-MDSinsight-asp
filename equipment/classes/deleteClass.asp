...
If InternalRecordIdentifier <> "" Then
	...
	SQLDelete = "Select * FROM EQ_Classes WHERE InternalRecordIdentifier = "& InternalRecordIdentifier 
	...
	If not rsDelete.Eof Then EquipmentClass = rsDelete("Class")
	...
	SQLDelete = "Delete FROM EQ_Classes WHERE InternalRecordIdentifier = "& InternalRecordIdentifier 
	...
	Description = "The " & GetTerm("Equipment") & " class named " & EquipmentClass & " was deleted by " & GetUserDisplayNameByUserNo(Session("UserNo")) 
