...
<h1 class="page-header">View Customer Equipment Class Details For <strong><%= GetClassNameByIntRecID(InternalRecordIdentifier) %></strong></h1>

<div class="row">
 	<div class="col-lg-12">
	 	<p><a href="<%= BaseURL %>equipment/classes/main.asp"><button type="button" class="btn btn-success">Return To Main Classes Screen</button></a></p>
 	</div>
</div>
	...
	<div class="table-responsive">
            <table class="table table-striped table-condensed table-hover table-bordered sortable">
              ...
              <tbody class='searchable'>
				...
				SQLCustomerEquipment = SQLCustomerEquipment & " WHERE EQ_Models.ClassIntRecID = " & InternalRecordIdentifier & " ORDER BY EQ_Equipment.ModelIntRecID "
