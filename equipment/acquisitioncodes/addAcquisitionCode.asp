...
<!--
    function validateAcquisitionCodeForm()
    {
        ...
        if (document.frmAddAcquisitionCode.txtAcquisitionCode.value == "") {
            swal("Acquisition Code cannot be blank.");
            return false;
        }

        if (document.frmAddAcquisitionCode.txtAcquisitionCodeDesc.value == "") {
...
<h1 class="page-header"> Add New <%= GetTerm("Equipment") %> Acquisition Code</h1>

<div class="custom-container">

	<form method="POST" action="addAcquisitionCode_submit.asp" name="frmAddAcquisitionCode" id="frmAddAcquisitionCode" onsubmit="return validateAcquisitionCodeForm();">
