...
<!--
    function validateGroupForm()
    {
        ...
        if (document.frmAddGroup.txtGroup.value == "") {
...
<h1 class="page-header"> Add New <%= GetTerm("Equipment") %> Group</h1>

<div class="custom-container">

	<form method="POST" action="addGroup_submit.asp" name="frmAddGroup" id="frmAddGroup" onsubmit="return validateGroupForm();">
		...
		<div class="row row-line">
			...
			<div class="form-group col-lg-12">
    			...
    			<div class="col-sm-6">
    				<input type="text" class="form-control required" id="txtGroup" name="txtGroup">
    			</div>
			</div>
