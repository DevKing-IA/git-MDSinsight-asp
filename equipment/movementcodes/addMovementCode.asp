...
<!--
    function validateMovementCodeForm()
    {
        ...
        if (document.frmAddMovementCode.txtMovementCode.value == "") {
            swal("Movement Code cannot be blank.");
            return false;
        }

        if (document.frmAddMovementCode.txtMovementCodeDesc.value == "") {
...
<h1 class="page-header"> Add New <%= GetTerm("Equipment") %> Movement Code</h1>

<div class="custom-container">

	<form method="POST" action="addMovementCode_submit.asp" name="frmAddMovementCode" id="frmAddMovementCode" onsubmit="return validateMovementCodeForm();">
