...
<h1 class="page-header">View Customer Equipment Movement Code Details For <strong><%= GetMovementCodeByIntRecID(InternalRecordIdentifier) %> - <%= GetMovementCodeDescByIntRecID(InternalRecordIdentifier) %></strong></h1>
	...
	<div class="table-responsive">
            <table class="table table-striped table-condensed table-hover table-bordered sortable">
              ...
              <tbody class='searchable'>
				...
				SQLCustomerEquipment = SQLCustomerEquipment & " WHERE EQ_Equipment.MovementCodeIntRecID = " & InternalRecordIdentifier & " ORDER BY EQ_Equipment.ModelIntRecID "
