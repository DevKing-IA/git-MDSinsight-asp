...
<!--
    function validateStatusCodeForm()
    {
        ...
        if (document.frmAddStatusCode.txtStatusCode.value == "") {
            swal("Status Code name/desc cannot be blank.");
            return false;
        }

        if (document.frmAddStatusCode.txtBackendSystemCode.value == "") {
...
<h1 class="page-header"> Add New <%= GetTerm("Equipment") %> Status Code</h1>

<div class="custom-container">

	<form method="POST" action="addStatusCode_submit.asp" name="frmAddStatusCode" id="frmAddStatusCode" onsubmit="return validateStatusCodeForm();">

		<div class="row row-line">
			<div class="form-group col-lg-12">
				<label for="txtStatusCode" class="col-sm-3 control-label">Status Code Desc</label>	
    			<div class="col-sm-6">
    				<input type="text" class="form-control required" id="txtStatusCode" name="txtStatusCode">
    			</div>
			</div>
		</div>
