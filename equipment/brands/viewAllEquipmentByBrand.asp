...
<h1 class="page-header">View Brand Details For <strong><%= GetBrandNameByIntRecID(InternalRecordIdentifier) %></strong></h1>
	...
	<div class="table-responsive">
            <table class="table table-striped table-condensed table-hover table-bordered sortable">
              ...
              <tbody class='searchable'>
				...
				SQL = SQL & " WHERE EQ_Models.BrandIntRecID = " & InternalRecordIdentifier & " ORDER BY ClassIntRecID"
