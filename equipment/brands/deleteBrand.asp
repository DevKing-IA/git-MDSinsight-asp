...
If InternalRecordIdentifier <> "" Then
	...
	SQLDelete = "Select * FROM EQ_Brands WHERE InternalRecordIdentifier = "& InternalRecordIdentifier 
	...
	If not rsDelete.Eof Then Brand = rsDelete("Brand")
	...
	SQLDelete = "Delete FROM EQ_Brands WHERE InternalRecordIdentifier = "& InternalRecordIdentifier 
	...
	Description = "The " & GetTerm("Equipment") & " brand named " & Brand & " was deleted by " & GetUserDisplayNameByUserNo(Session("UserNo")) 
