...
<h1 class="page-header">View Customer Equipment Model Details For <strong><%= GetModelNameByIntRecID(InternalRecordIdentifier) %></strong></h1>

<div class="row">
 	<div class="col-lg-12">
	 	<p><a href="<%= BaseURL %>equipment/models/main.asp"><button type="button" class="btn btn-success">Return To Main Models Screen</button></a></p>
 	</div>
</div>
	...
	<div class="table-responsive">
            <table class="table table-striped table-condensed table-hover table-bordered sortable">
              ...
              <tbody class='searchable'>
				...
				SQLCustomerEquipment = SQLCustomerEquipment & " WHERE EQ_Models.InternalRecordIdentifier = " & InternalRecordIdentifier & " ORDER BY EQ_Equipment.ModelIntRecID "
