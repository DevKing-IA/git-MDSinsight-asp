...
<!--#include file="../../../inc/InsightFuncs.asp"-->
  ...
  <head>
   ...
   <link href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css" rel="stylesheet">
    ...
    <link href="css/screensize.css" rel="stylesheet">
	...
	<!-- JS file -->
	<script src="<%= BaseURL %>js/easyautocomplete/EasyAutocomplete-1.3.5/jquery.easy-autocomplete.min.js"></script> 
	<!-- CSS file -->
	<link rel="stylesheet" href="css/EasyAutocomplete-1.3.5/easy-autocomplete-mobile.css"> 
	<!-- Additional CSS Themes file - not required-->
	<link rel="stylesheet" href="css/EasyAutocomplete-1.3.5/easy-autocomplete.themes.css"> 
