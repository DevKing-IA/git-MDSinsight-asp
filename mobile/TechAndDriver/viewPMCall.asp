		...
		$('#PleaseWaitPanel').show();
				  var  assetnum=asst;
				   ...
				   if(asst!='')
				   {
				    $.ajax({
				   type:'post',
				      url:'assigntomePMCall.asp',
				          data:{txtAssetNumber: assetnum},
							success: function(msg){
								window.location = "assignToMePMCall_Done.asp";
								$('#PleaseWaitPanel').hide();
							}
				 });
				  }
...
<div class="container-fluid buttons-fluid">
	<div class="row">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 button-box">
			<form name="frmAssignToMePMCall" id="frmAssignToMePMCall">
...
<div class="row row-common">
	<div class="col-lg-6">
		<table style="width:100%;">
			<tr><td align="right"><b>PM Call Info:</b></td><td>&nbsp;&nbsp;&nbsp;</td><td align="left"><%=rs("Comment1")%>
