...
<SCRIPT LANGUAGE="JavaScript">
    ...
    {
        if (document.frmfollowup.selAssetID.value != "") {
      	  if (document.frmfollowup.txtAssetTagNumber.value != "") {
        ...
        if (document.frmfollowup.selAssetID.value != "") {
      	  if (document.frmfollowup.txtAssetLocation.value == "") {
...
Follow Up Ticket # <%=SelectedMemoNumber%></h1>
 

<div class="container-fluid fieldservice-container">
	<div class="row">
 
		<form action="followup_submit.asp" method="POST" ENCTYPE="multipart/form-data" name="frmfollowup" id="frmfollowup" onsubmit="return validatefollowupform();"> 
		...
		<input type='hidden' id='txtTicketNumber' name='txtTicketNumber' value='<%=SelectedMemoNumber%>'>		 
			...
			<div class="row row-rest">
				<h4 class="close-service-h4"><i class="fa fa-comments"></i> Follow Up Notes</h4>
