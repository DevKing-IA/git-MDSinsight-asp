...
<SCRIPT LANGUAGE="JavaScript">
    ...
    function doSeek() {
        $(".scan-result").html("");
        $(".scan-result").load("availableload.asp", { code: $('#txtUPCCode').val() }, function (response, status, xhr) {
            if (status == "error") {
...
<h1 class="inventory-upc-heading"><a href="../main_menu.asp" class="left-arrow"><i class="fa fa-arrow-left pull-left" aria-hidden="true"></i></a> SKU Availability Lookup</h1>
