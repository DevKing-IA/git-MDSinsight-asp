...
productUPC = Request.Form("txtproductUPC")
...
If Not rsRepost.Eof Then
	...
	Select Case rsRepost("prodCasePricing")
		Case "N"
			...
			productUnitUPC = productUPC 
		Case "U"
			productUnitUPC = productUPC 			
		Case "C"
			productCaseUPC = productUPC 
		Case Else
			UnitBinLocation = BinLocation		
			productUnitUPC = productUPC 			
	End Select
	...
	xmlData = xmlData & "        <UNIT_UPC>" & productUnitUPC & "</UNIT_UPC>"
	xmlData = xmlData & "        <CASE_UPC>" & productCaseUPC & "</CASE_UPC>"
	xmlData = xmlData & " </REPLACE_ONHAND>"
...
Response.Redirect("upclookup.asp")	
