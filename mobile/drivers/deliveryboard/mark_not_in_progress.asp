...
If  IvsNum <> "" Then
	...
	SQLDeliveryBoard = "Update RT_DeliveryBoard Set DeliveryInProgress = 0 Where IvsNum = " & IvsNum
	...
	'*******************************
	Description = GetUserDisplayNameByUserNo(Session("UserNo")) & " set delivery to Not In Progress for invoice " & IvsNum  & " for customer " & CustNum & " at " & NOW()
