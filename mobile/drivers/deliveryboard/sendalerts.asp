...
cnn_Alert.open (MUV_READ("ClientCnnString"))
	...
	Do While Not rsAlert.EOF
		...
		If Send_To <> "" Then
			...
			For x = 0 to Ubound(Send_To_Array) -1
				...
				SendMail "mailsender@" & maildomain,Send_To,"Delivery Alert " & SERNO,emailBody,GetTerm("Routing"),"Delivery Alert"
			Next 
		End If
