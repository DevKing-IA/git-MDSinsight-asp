...
<h1 class="page-header"> Add New Symptom Code</h1>

<div class="custom-container">

	<form method="POST" action="addsymptomCode_submit.asp" name="frmAddSymptomCode" id="frmAddSymptomCode" onsubmit="return validatesymptomCodeForm();">

		<div class="row row-line">

			<div class="form-group col-lg-12">
				<label for="txtSymptomDescription" class="col-sm-3 control-label">Description</label>	
    			<div class="col-sm-6">
    				<input type="text" class="form-control required" id="txtSymptomDescription" name="txtSymptomDescription" >
    			</div>
			</div>
