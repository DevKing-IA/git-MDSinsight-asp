...
<%
dummy = MUV_Write("selectedServiceTab","#16to40")
...
<div class="table-responsive">
    <table  id="tableSuperSum9" class="food_planner table table-condensed sortable">
      <thead>
        <tr>
          <th class="sorttable_numeric">Date</th>
          <th width="5%">Ticket #</th>	   
          <th class="sorttable_nosort">&nbsp;</th>y
	...
	If not rs.EOF Then
		...
		Do While Not rs.EOF
			...
			If ShowThisRec = True AND ServiceCallElapsedMinutesOpenTicket(rs.Fields("MemoNumber")) > (GetNumberOfMinutesInServiceDay() * 2)+1 AND ServiceCallElapsedMinutesOpenTicket(rs.Fields("MemoNumber")) <= GetNumberOfMinutesInServiceDay() * 5 Then
				%>
