...
<%
dummy = MUV_Write("selectedServiceTab","#onhold")
...
<div class="table-responsive">
	...
	SQL = "SELECT * FROM FS_ServiceMemos WHERE CurrentStatus = 'HOLD' ORDER BY submissionDateTime DESC"
	...
	If not rs.EOF Then
		...
		Do While Not rs.EOF
			...
			%>
				<!--#include file="mainTabTableDataAllTabsOnHold.asp"-->
			<%	
