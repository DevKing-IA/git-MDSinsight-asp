...
<%
dummy = MUV_Write("selectedServiceTab","#enrouteonsite")
...
<div class="table-responsive">
    <table  id="tableSuperSum4" class="food_planner table table-condensed sortable">
      <thead>
        <tr>
	...
	If not rs.EOF Then
		...
		Do While Not rs.EOF
			...
			If ShowThisRec = True AND rs.Fields("RecordSubType") <> "HOLD" AND (GetServiceTicketCurrentStageVar = "En Route" OR GetServiceTicketCurrentStageVar = "On Site") Then
