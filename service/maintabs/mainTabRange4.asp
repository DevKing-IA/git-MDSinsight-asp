...
<%
dummy = MUV_Write("selectedServiceTab","#over40")
...
<div class="table-responsive">
    <table  id="tableSuperSum10" class="food_planner table table-condensed sortable">
      <thead>
        <tr>
...
Set rs = cnn8.Execute(SQL)
	...
	If not rs.EOF Then
		...
		Do While Not rs.EOF
			...
			If ShowThisRec = True AND ServiceCallElapsedMinutesOpenTicket(rs.Fields("MemoNumber")) > GetNumberOfMinutesInServiceDay() * 5 Then
