...
<%
dummy = MUV_Write("selectedServiceTab","#acknowledged")
...
<div class="table-responsive">
    <table id="tableSuperSum3" class="food_planner table table-condensed sortable">
      <thead>
        <tr>
	...
	If not rs.EOF Then
		...
		Do While Not rs.EOF
			...
			If ShowThisRec = True AND rs.Fields("RecordSubType") <> "HOLD" AND GetServiceTicketCurrentStageVar = "Dispatch Acknowledged" Then
