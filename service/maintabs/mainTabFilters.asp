...
<%
dummy = MUV_Write("selectedServiceTab","#filters")
...
<div class="table-responsive">
	...
	SQL = "SELECT * FROM FS_ServiceMemos WHERE FilterChange = 1 AND CurrentStatus = 'OPEN' AND RecordSubType = 'OPEN' ORDER BY submissionDateTime DESC"
	...
	If not rs.EOF Then
		...
		Do While Not rs.EOF
			...
			If rs.Fields("RecordSubType") <> "HOLD" AND (GetServiceTicketCurrentStageVar <> "Unable To Work" AND GetServiceTicketCurrentStageVar <> "Swap" AND GetServiceTicketCurrentStageVar <> "Wait for parts" AND GetServiceTicketCurrentStageVar <> "Follow Up") Then
