<%	
	...
	ticketStageDateTime = GetHOLDServiceTicketSTAGEDateTime(rs.Fields("MemoNumber"),GetServiceTicketCurrentStageVar)
	...
	If userIsServiceManager(Session("userNo")) or userIsAdmin(Session("userNo")) Then%>  
		...
		<% Else 
			If AwaitingRedispatch(rs.Fields("MemoNumber")) = True Then
				...
				'Response.Write(GetHOLDServiceTicketSTAGEDateTime(rs.Fields("MemoNumber"),GetServiceTicketCurrentStageVar))
