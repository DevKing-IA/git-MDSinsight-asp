...
<h1 class="page-header"> Add New Problem Code</h1>

<div class="custom-container">

	<form method="POST" action="addproblemCode_submit.asp" name="frmAddproblemCode" id="frmAddproblemCode" onsubmit="return validateproblemCodeForm();">

		<div class="row row-line">

			<div class="form-group col-lg-12">
				<label for="txtProblemDescription" class="col-sm-3 control-label">Description</label>	
    			<div class="col-sm-6">
    				<input type="text" class="form-control required" id="txtProblemDescription" name="txtProblemDescription" >
    			</div>
			</div>
