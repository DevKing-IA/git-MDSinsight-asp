...
SQLDispatch = SQLDispatch & " MemoStage ='Dispatch Acknowledged' AND "
...
'*******************************
Description = GetUserDisplayNameByUserNo(UserNumber) & " acknowldged the dispatch for service ticket number " & ServiceTicketNumber & " at " & NOW()
