<%	
	...
	'****************************************************************************************
	 Response.Write("Begin Entries for AR_Customer Secondary Salesman<br><br>")
	'****************************************************************************************
	...
	'**************************************************************************************************************
	SQL_ARCustomer = "DELETE FROM SC_NeedToKnow WHERE Module = 'Accounts Receivable' AND SubModule ='Secondary Salesman'"
	...
	If NOT rsARCustomer.EOF Then
		...
		Do While NOT rsARCustomer.EOF
			...
			SCNeedToKnow_SubModule = "Secondary Salesman"
			SCNeedToKnow_SummaryDescription = "Missing secondary salesman"
			SCNeedToKnow_DetailedDescription1 = "The secondary salesmen for customer " & CustName & " (" & CustNum & ") located at " & Addr1 & ", " & CityStateZip & " is missing. Every account must have a valid secondary salesman."
	...
	'****************************************************************************************
	 Response.Write("End Entries for AR_Customer Secondary Salesman<br><br>")
	'****************************************************************************************
