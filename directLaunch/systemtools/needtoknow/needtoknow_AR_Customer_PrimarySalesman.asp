<%	
	...
	'****************************************************************************************
	 Response.Write("Begin Entries for AR_Customer " & GetTerm("Primary Salesman") & "<br><br>")
	'****************************************************************************************
	...
	'**************************************************************************************************************
	SQL_ARCustomer = "DELETE FROM SC_NeedToKnow WHERE Module = 'Accounts Receivable' AND SubModule ='Primary Salesman'"
	...
	If NOT rsARCustomer.EOF Then
		...
		Do While NOT rsARCustomer.EOF
			...
			SCNeedToKnow_SubModule = "Primary Salesman"
			SCNeedToKnow_SummaryDescription = "Missing primary salesman"
			SCNeedToKnow_DetailedDescription1 = "The primary salesmen for customer " & CustName & " (" & CustNum & ") located at " & Addr1 & ", " & CityStateZip & " is missing. Every account must have a valid primary salesman."
	...
	'****************************************************************************************
	 Response.Write("End Entries for AR_Customer Primary Salesman<br><br>")
	'****************************************************************************************
