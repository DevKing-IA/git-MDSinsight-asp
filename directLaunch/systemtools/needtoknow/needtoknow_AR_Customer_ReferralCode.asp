<%	
	...
	'****************************************************************************************
	 Response.Write("Begin Entries for AR_Customer Referral Code<br><br>")
	'****************************************************************************************
	...
	'**************************************************************************************************************
	SQL_ARCustomer = "DELETE FROM SC_NeedToKnow WHERE Module = 'Accounts Receivable' AND SubModule ='Referral Code'"
	Set rsARCustomer = cnnARCustomer.Execute(SQL_ARCustomer)
	'**************************************************************************************************************
	
	
	SQL_ARCustomer = "SELECT * FROM AR_Customer WHERE ReferalCode = 0 AND AcctStatus <> 'X' ORDER BY CustNum ASC"
	Set rsARCustomer = cnnARCustomer.Execute(SQL_ARCustomer)
	...
	If NOT rsARCustomer.EOF Then
		...
		Do While NOT rsARCustomer.EOF
			...
			SCNeedToKnow_SubModule = "Referral Code"
			SCNeedToKnow_SummaryDescription = "Missing referral code"
			SCNeedToKnow_DetailedDescription1 = "The referral code for customer " & CustName & " (" & CustNum & ") located at " & Addr1 & ", " & CityStateZip & " is not filled in. Every account must have a valid referral code."
	...
	'****************************************************************************************
	 Response.Write("End Entries for AR_Customer Referral Code<br><br>")
	'****************************************************************************************
