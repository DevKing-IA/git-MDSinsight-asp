...
If NOT rsDailyAPIPartnersLoop.EOF Then
	...
	Do While Not rsDailyAPIPartnersLoop.EOF
		...
		currentPartnerAPIKey = rsDailyAPIPartnersLoop("partnerAPIKey")
			...
			Response.Write("<table style='margin-left:20px;width:1300px;'>")	
				...
				SQLDailyAPIOrders = SQLDailyAPIOrders & " ORDER BY RecordCreationDateTime"
	'Response.Write(SQLDailyAPIOrders)
			...
			Response.Write("<table style='margin-left:20px;width:1300px'>")	
				...
				SQLDailyAPIInvoices = SQLDailyAPIInvoices & " ORDER BY RecordCreationDateTime"
...
Sub PageHeader
	...
	If PageNo > 1 Then Response.Write("<div style='page-break-before: always'>")
 	...
 	Response.Write("<img src='/clientfiles/" & ClientKey & "/logos/logo.png' style='float:left; margin-top:30px;'><center><h1 >DAILY API LOG <Br>BY PARTNER"  & "</h1><h2 class='generated' >Generated " & WeekDayName(WeekDay(DateValue(Now()))) & "&nbsp;" &  Now() & "</h2></center>")
