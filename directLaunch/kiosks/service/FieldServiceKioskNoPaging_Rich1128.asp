	   ...
	   $(document).ready(function(){		
		...
		$('#serviceBoardTicketOptionsModal').on('show.bs.modal', function(e) {
	    	...
	    	$.ajax({
				...
				cache: false,
				data: "action=GetContentForServiceBoardTicketOptionsModal&returnURL=directLaunch/kiosks/service/FieldServiceKioskNoPaging_Rich1128.asp&memoNum=" + encodeURIComponent(myTicketNumber) + "&custID=" + encodeURIComponent(myCustID) + "&userNo=" + encodeURIComponent(myUserNo),
