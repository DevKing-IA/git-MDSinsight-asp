	   ...
	   $(document).ready(function(){	
			...
			$('#deliveryBoardInvoiceOptionsModal').on('show.bs.modal', function(e) {
		    	...
		    	$.ajax({
					...
					url: "../../../inc/InSightFuncs_AjaxForRoutingModals.asp",
					cache: false,
					data: "action=GetContentForDeliveryBoardOptionsModal&returnPage=directLaunch/kiosks/routing/DeliveryBoardKioskNoPaging_Rich1071.asp&invoiceNum=" + encodeURIComponent(myInvoiceNumber) + "&custID=" + encodeURIComponent(myCustID) + "&truckNum=" + encodeURIComponent(myTruckNumber),
					success: function(response)
					 {
			...
			var pagetimer = new Timer(function() {
			   ...
			   window.location = "<%= BaseURL %>/directlaunch/kiosks/service/fieldservicekiosknopaging_Rich1230.asp?pp=Hicksville&cl=1230&ri=8";
