...
<!-- eof logo / heading !-->
    ...
    <form action="<%= BaseURL %>reset-password-ql.asp?action=captcha" method="POST" name="frmPasswordReset" id="frmPasswordReset" onSubmit="return checkFormWithCaptcha();" class="form-signin">
    ...
    <div class="quicklogin-container">
        ...
        <h2 class="quicklogin">Reset Password</h2>
        ...
        <div class="row line">
        	<div class="col-lg-10 col-md-10 col-sm-9 col-xs-9">
            	<input type="text" placeholder="type validation code here" class="input" name="txtCaptcha" id="txtCaptcha">
            </div>
        ...
        <div class="row line">
        	<div class="col-lg-12">
		         <a href="<%= BaseURL %>ql.asp?u=<%= QuickUserNo %>&c=<%= QuickClientID %>">Nevermind, return to login</a>
            </div>
        </div>        
         <!-- eof forgot password !-->
