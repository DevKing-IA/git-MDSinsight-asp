	...
	If Not rs1.Eof Then
		Do While Not rs1.EOF
				...
				Do While Not rs.EOF
					...
					Else
						...
						If ShowThisRecord <> False Then
							...
							' Else
							' 	total_MaxMCSCharge = total_MaxMCSCharge + MaxMCSCharge
							' End If				
			...
			If record_num > 0 Then
				...
				Response.Write("<td align='right' class='smaller-detail-line'>" & FormatCurrency(total_ShortageHolder, 0) & "</td>") ' shortage last 3 month
				...
				Response.Write("<td align='right' class='smaller-detail-line'>" & FormatCurrency(total_CurrentMonthVarianceHolder, 0 ,0 ,0) & "</td>") ' MTD variance
				...
				Response.Write("<td align='right' class='smaller-detail-line'>" & FormatCurrency(total_RentalHolder, 0) & "</td>") ' last month Rental
		...
		%>
				<thead>				
					<tr>
						<th class="td-align sorttable_numeric smaller-header child-head" style="border-left: 2px solid #555 !important; border-top: 2px solid #555 !important; width:55px;" id="salesColumn"><br></th>
						<th class="td-align sorttable_numeric smaller-header child-head" style="border-top: 2px solid #555 !important;width:67px;" id="salesColumn"><br>Acct</th>
						<th class="td-align sorttable_numeric smaller-header child-head" style="border-top: 2px solid #555 !important; width:64px;" id="salesColumn"><br>Client</th>
						<th class="td-align sorttable_numeric smaller-header child-head" style="border-top: 2px solid #555 !important;width:66px;" id="salesColumn">Primary<br> Slsmn</th>
						<th class="td-align sorttable_numeric smaller-header child-head" style="border-top: 2px solid #555 !important;width:85px;" id="salesColumn">Secondary<br> Slsmn</th>
						<th class="td-align sorttable_numeric smaller-header child-head" style="border-top: 2px solid #555 !important;width:54px;" id="salesColumn">Install<br> Date</th>

						<th class="td-align sorttable_numeric smaller-header child-head" style="border-left: 2px solid #555 !important;width:47px; border-top: 2px solid #555 !important;" id="salesColumn"><%=MonthName(Month(DateAdd("m",-3,ReportDate)),1) %><br><%= Year(DateAdd("m",-3,ReportDate))%></th>
						<th class="td-align sorttable_numeric smaller-header child-head" style="border-top: 2px solid #555 !important;width:45px;" id="salesColumn"><%=MonthName(Month(DateAdd("m",-2,ReportDate)),1) %><br><%= Year(DateAdd("m",-2,ReportDate))%></th>
						<th class="td-align sorttable_numeric smaller-header child-head" style="border-top: 2px solid #555 !important;width:45px;" id="salesColumn"><%=MonthName(Month(DateAdd("m",-1,ReportDate)),1) %><br><%= Year(DateAdd("m",-1,ReportDate))%></th>
						<th class="td-align sorttable_numeric smaller-header child-head" style="border-top: 2px solid #555 !important; width: 47px;" id="salesColumn">3 Prior<br>mos avg $</th>
						<th class="td-align sorttable_numeric smaller-header child-head" style="border-top: 2px solid #555 !important; width: 74px;" id="salesColumn">Shortage<br>Last 3 mos</th>
						<th class="td-align sorttable_numeric smaller-header child-head" style="border-top: 2px solid #555 !important;width:51px;" id="salesColumn"><%=MonthName(Month(ReportDate),1) %><br>Sales $</th>
						<th class="td-align sorttable_numeric smaller-header child-head" style="border-top: 2px solid #555 !important;width:73px;" id="salesColumn">GP$<br><%=MonthName(Month(DateAdd("m",-1,ReportDate)),1) %>&nbsp;<%= Year(DateAdd("m",-1,ReportDate))%></th>

						
						<th class="td-align sorttable_numeric smaller-header child-head" style="border-left: 2px solid #555 !important; border-top: 2px solid #555 !important;width:51px;" id="salesColumn"><br>MCS</th>
						<th class="td-align sorttable_numeric smaller-header child-head" style="border-top: 2px solid #555 !important;width:73px;" id="salesColumn"><%=MonthName(Month(DateAdd("m",-1,ReportDate)),1) %>&nbsp;MCS<br>Variance</th>
						<th class="td-align sorttable_numeric smaller-header child-head" style="border-top: 2px solid #555 !important;width:73px;" id="salesColumn"><%=MonthName(Month(ReportDate),1) %>&nbsp;MTD<br>Variance</th>					
						<th class="td-align sorttable_numeric smaller-header child-head" style="border-top: 2px solid #555 !important;width:86px;" id="salesColumn">Enrollment<br>Date</th>
						<th class="td-align sorttable_numeric smaller-header child-head" style="border-top: 2px solid #555 !important;width: 72px; border-right: 2px solid #555 !important;" id="salesColumn" >Pending<br>LVF</th>	
						<th class="td-align sorttable_numeric smaller-header child-head" style="border-top: 2px solid #555 !important;width:67px;" id="salesColumn"><%= MonthName(Month(DateAdd("m",-1,ReportDate))) %><br>Rental $</th>
						<th class="td-align sorttable_numeric smaller-header child-head" style="border-top: 2px solid #555 !important;width:74px;" id="salesColumn">LVF<br><%=MonthName(Month(DateAdd("m",-2,ReportDate)),1) %>&nbsp;<%= Year(DateAdd("m",-3,ReportDate))%></th>
										
						<th class="td-align sorttable_numeric smaller-header child-head" style="border-top: 2px solid #555 !important;width:42px;" id="salesColumn">Max LVF<br>&nbsp;</th>
						
						<th class="td-align sorttable_numeric smaller-header child-head" style="border-right: 2px solid #555 !important; border-top: 2px solid #555 !important; border-left: 2px solid #555 !important;width:104px;" id="salesColumn">Eqp Value</th>
						
						<th class="td-align sorttable_numeric smaller-header child-head" style="border-top: 2px solid #555 !important;width:57px;" id="salesColumn"><br>Action</th>
						<th class="td-align sorttable_numeric smaller-header child-head" style="border-right: 2px solid #555 !important; border-top: 2px solid #555 !important;width:85px;" id="salesColumn">Additional<br>Info</th>
					...
					Do While Not rs.EOF
						...
						Else 
							...
							If ShowThisRecord <> False Then
								...
								Response.Write(">")
								Response.Write("<td class='smaller-detail-line'></td>")
