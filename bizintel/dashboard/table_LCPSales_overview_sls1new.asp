...
'Response.Write(SQL&"<br>")	
	...
	SQL = "SELECT * FROM BI_DashBoard WHERE Segment='PrimarySalesman'"
	...
	If not rs.EOF Then
		...
		<thead>
			...
			<tr id="sls1TopHeaderRow">	
				...
				<th id="sls1TopHeaderRow3" colspan="5" class="td-align1 referral-color" style="width:30% !important; border-right:2px solid #555 !important;border-bottom:2px solid #555 !important;">Average Daily Sales Variances</th>
			</tr>
		...
		<tbody>
			...
			Do
				...
				If rs("SalesLCP") + rs("Sales3PPAvg")  < 1 Then
					Response.Write("<td align='left' class='smaller-detail-line'>" & rs("PrimarySalesmanNumber") & " - " & rs("PrimarySalesmanName") & "</td>")													
				Else
					Response.Write("<td align='left' class='smaller-detail-line'><a href='dashboard_segment_primarysalesman.asp?p=" & rs("PrimarySalesmanNumber") & "' target='_blank'>"& rs("PrimarySalesmanNumber") & " - " & rs("PrimarySalesmanName") & "</a></td>")									
				End IF
