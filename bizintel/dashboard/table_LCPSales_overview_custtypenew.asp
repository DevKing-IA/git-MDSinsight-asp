<div style="width: 100%; overflow-y: scroll; margin: 0 auto">
	...
	SQL = "SELECT * FROM BI_DashBoard WHERE Segment='CustomerType'"
	...
	If not rs.EOF Then
		...
		<thead>
			...
			<tr id="custtypeTopHeaderRow">	
				<th id="custtypeTopHeaderRow1" rowspan="2" colspan="1" style="width:10% !important; border-right:2px solid #555 !important;border-bottom:2px solid #555 !important;">Customer Type</th>
				<th id="custtypeTopHeaderRow2" colspan="4" class="td-align1 cust-type-color" style="width:24% !important; border-right:2px solid #555 !important;border-bottom:2px solid #555 !important;">Sales</th>
				<th id="custtypeTopHeaderRow4" colspan="6" class="td-align1 gen-info-header" style="width:36% !important; border-right:2px solid #555 !important;border-bottom:2px solid #555 !important;">Average Daily Sales</th>
				<th id="custtypeTopHeaderRow3" colspan="5" class="td-align1 referral-color" style="width:30% !important; border-right:2px solid #555 !important;border-bottom:2px solid #555 !important;">Average Daily Sales Variances</th>
			</tr>
		
		  	<tr id="custtypeBottomHeaderRow">
				<th id="custtypeBottomHeaderRow1" class="dollar-amount-header" style="border-right: 2px solid #555 !important;">Period&nbsp;<%=LCP_Display_Month%><br>Sales</th>
				<th id="custtypeBottomHeaderRow2" class="dollar-amount-header" style="border-right: 2px solid #555 !important;">3 Prior Periods<br>Average Sales</th>
				<th id="custtypeBottomHeaderRow3" class="dollar-amount-header" style="border-right: 2px solid #555 !important;">12 Prior Periods<br>Average Sales</th>
				<th id="custtypeBottomHeaderRow4" class="dollar-amount-header" style="border-right: 2px solid #555 !important;">Same Period<br>Last Year</th>
				
				<th id="custtypeBottomHeaderRow5" class="dollar-amount-header" style="border-right: 2px solid #555 !important;">Period&nbsp;<%=LCP_Display_Month%><br></th>
				<th id="custtypeBottomHeaderRow6" class="dollar-amount-header" style="border-right: 2px solid #555 !important;">3 Prior Periods<br>Average</th>
				<th id="custtypeBottomHeaderRow7" class="dollar-amount-header" style="border-right: 2px solid #555 !important;">12 Prior Periods<br>Average</th>
				<th id="custtypeBottomHeaderRow8" class="dollar-amount-header" style="border-right: 2px solid #555 !important;">Same Period<br>Last Year</th>
				<th id="custtypeBottomHeaderRow9" class="dollar-amount-header" style="border-right: 2px solid #555 !important;">Current Period<br>(So Far)</th>
				<%
				PeriodDisplayVar = ""
				...
				Else
					PeriodDisplayVar = 1
				End If %>
				<th id="custtypeBottomHeaderRow10" class="dollar-amount-header" style="border-right: 2px solid #555 !important;">Current<br>Last Year</th>
				
				<th id="custtypeBottomHeaderRow11" class="dollar-amount-header" style="border-right: 2px solid #555 !important;">Period&nbsp;<%=LCP_Display_Month%> vs<br>3 Prior Periods Average</th>
				<th id="custtypeBottomHeaderRow12" class="dollar-amount-header" style="border-right: 2px solid #555 !important;">Period&nbsp;<%=LCP_Display_Month%> vs<br>12 Prior Periods Average</th>
				<th id="custtypeBottomHeaderRow13" class="dollar-amount-header" style="border-right: 2px solid #555 !important;">Period&nbsp;<%=LCP_Display_Month%> vs<br>Same Period Last Year</th>
				<th id="custtypeBottomHeaderRow14" class="dollar-amount-header" style="border-right: 2px solid #555 !important;">Current vs 3<br>Prior Periods Average</th>
				<th id="custtypeBottomHeaderRow15" class="dollar-amount-header" style="border-right: 2px solid #555 !important;">Current vs<br>Current<br>Last Year</th>
			</tr>
		</thead>
		...
		<tbody>
			...
			Do
				...
				If rs("SalesLCP") + rs("Sales3PPAvg")  < 1 Then
					Response.Write("<td align='left' class='smaller-detail-line'>" & rs("CustomerTypeNumber") & " - " & rs("CustomerTypeName") & "</td>")													
				Else
					Response.Write("<td align='left' class='smaller-detail-line'><a href='dashboard_segment_customertype.asp?p=" & rs("CustomerTypeNumber") & "' target='_blank'>"& rs("CustomerTypeNumber") & " - " & rs("CustomerTypeName") & "</a></td>")									
				End IF
			...
			If Not rs.EOF Then
				Do While Not rs.EOF
					...
					If SPLYProductsSales <> 0 Then 
						...
						Response.Write("<td align='left' class='smaller-detail-line'>" & rs("CustType") & " - " & GetCustTypeByCode(rs("CustType")) & "</td>")									
