...
<table id="tableDataBottomNew" class="display compact" style="width:100%;">
...
<%
	...
	Select Case MUV_READ("LOHVAR")
		Case "Secondary"
			...
			SQL = "SELECT TOP 50 * FROM BI_DashboardSegmentTabs WHERE Tab = 'ALL' AND SecondarySalesmanNumber = " & Segment & " ORDER BY TwelvePAvgSales ASC"
