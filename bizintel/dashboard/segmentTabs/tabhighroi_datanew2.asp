...
<table id="tableDataHighRoiNew" class="display compact" style="width:100%;">
...
<%
	...
	Select Case MUV_READ("LOHVAR")
		Case "Secondary"
			...
			SQL = "SELECT * FROM BI_DashboardSegmentTabs WHERE Tab = 'HIGHROI' AND SecondarySalesmanNumber = " & Segment
