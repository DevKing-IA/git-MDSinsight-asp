...
<table id="tableDataZeroSalesNew" class="display compact" style="width:100%;">
...
<%
	...
	Select Case MUV_READ("LOHVAR")
		Case "Secondary"
			...
			SQL = "SELECT * FROM BI_DashboardSegmentTabs WHERE Tab = 'ZEROSALES' AND SecondarySalesmanNumber = " & Segment 
