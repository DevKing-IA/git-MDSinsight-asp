	...
	If not rs.EOF Then
		...
		<tbody>
			...
			Do
				...
				Else
					Response.Write("<td align='left' class='smaller-detail-line'><a href='dashboard_segment_customertype.asp?p=" & rs("CustType") & "' target='_blank'>"& rs("CustType") & " - " & GetCustTypeByCode(rs("CustType")) & "</a></td>")									
				End IF
				...
				CP = (GetCurrentPeriod_PostedTotalCustTyp(Sls22Find) + GetCurrentPeriod_UnPostedTotalCustType(Sls22Find)) 
