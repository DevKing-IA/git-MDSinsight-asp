	...
	<div class="modal-dialog modal-lg modal-height">
		<div class="modal-content">
			...
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel" align="center">Sales By Period and Customer Class (Detail)</h4>
			</div>

			<form method="post" action="SalesByPeriodDetail_Customize_SaveValues.asp" name="frmSalesByPeriod_Customize" onsubmit="return validateCustomizeForm();">
