	...
	<div class="modal-dialog modal-lg modal-height">
		<div class="modal-content">
			...
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel" align="center">Sales By Day and Customer Class (Summary)</h4>
			</div>

			<form method="post" action="SalesByDaySummary_Customize_SaveValues.asp" name="frmSalesByDay_Customize" onsubmit="return validateCustomizeForm();">
				      	...
				      	<!-- row !-->
					      	<div class="row categories-checkboxes ">
						      	...
						      	<!--<div class="col-lg-12">
 								  <div class="checkbox">
    								<label>
    								  <input type="checkbox" class="check" id="checkAll"> <strong>CHECK / UNCHECK ALL</strong>
    								</label>
								  </div>
						      	</div>-->
