...
SQLDispatch = SQLDispatch & "FilterChange = 1 AND "
...
Response.Write("This filter change has been assigned to you. It now appears in your list of service tickets.")
%>