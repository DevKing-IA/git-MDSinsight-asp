...
If InternalNoteNumber  <> "" Then
	...
	Description = ""
	Description = Description & "An account note was moved from archive to current for account # "  & heldCustNum 
	...
	CreateAuditLogEntry "Account Note Moved To Current","Account Note Move To Current","Minor",0,Description


	SQLArchiveNote = "UPDATE tblCustomerNotes Set Archived = 0, ArchivedByUserNo = 0 WHERE InternalNoteNumber = "& InternalNoteNumber 
	Set rsArchiveNote = cnnArchiveNote.Execute(SQLArchiveNote)
