...
ImpVar = baseURL & "accountsreceivable/reports/consolidatedInv/consolidated_stmt_frm_acct_PDFgen.asp?s=" & Replace(StartDate,"/","~") & "&e=" & Replace(EndDate,"/","~")& "&c=" & Account
...
If IncludeIndividuals ="T" Then
	...
	If DebugMessages = True Then Response.Write("SQLIncludeIndividuals:" & SQLIncludeIndividuals & "<br>")
	...
	If not rsIncludeIndividuals.eof then
		...
		Do while not rsIncludeIndividuals.EOF
			...
			If DebugMessages = True Then Response.Write("fn2 " & fn2 & "<br>")
	...
	If DebugMessages = True Then Response.Write("About To Append To: " & Main_PDF_Filename & "<br>")
	...
	For x = 1 to DocPartCounter - 1
		...
		If DebugMessages = True Then Response.Write("IndividualFile Stiching of File: " & IndividualFile & "<br>")
	...
	If DebugMessages = True Then Response.Write("generated file name: " & Filename & "<br>")
...
If IncludeIndividuals = "T" Then
	...
	''''Orig_Name = "\clientfiles\" & Left(MUV_Read("ClientID"),4) & "\z_pdfs\ConsolidatedStatement_" & Trim(UniqueNum) & "_Main(1).pdf"
...
If DebugMessages = True Then Response.write("<br><br><br>Orig_Name " & Orig_Name & "<br>")
If DebugMessages = True Then Response.write("New_Name " & New_Name & "<br>")
...
<h1 class="page-header"><i class="fa fa-file-text"></i>  Consolidated Invoice (Account)</h1>
<!-- row !-->
