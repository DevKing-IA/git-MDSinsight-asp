ConsolidatedStatementinclude file="../../../inc/header-accounts-receivable.asp"-->
<style>
	#PleaseWaitPanel{
		position: fixed;
		left: 470px;
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$('#consolidatedInvoiceEmailModal').on('show.bs.modal', function(e) {
    		...
    		$modal.find('#myEmailConsolidatedInvoiceModalAccountLabel').html("Email Unpaid Consolidated Invoice for " + CustName + " - Invoice #" + InvoiceNumber);
    		
	    	$.ajax({
				type:"POST",
				url: "../../../inc/InSightFuncs_AjaxForARAP.asp",
				cache: false,
				data: "action=GetContentForEmailConsolidatedInvoiceModalAccount&consInvoiceNumber=" + encodeURIComponent(InvoiceNumber) + "&custID=" + encodeURIComponent(CustID) + "&endDate=" + encodeURIComponent(EndDate) + "&paidOrUnpaid=UNPAID",
...
ImpVar = baseURL & "accountsreceivable/reports/consolidatedInvUnpaid/consolidated_stmt_frm_acct_PDFgen.asp?s=" & Replace(StartDate,"/","~") & "&e=" & Replace(EndDate,"/","~")& "&c=" & Account
...
fn = "\clientfiles\" & Left(MUV_Read("ClientID"),4) & "\z_pdfs\ConsStmt_" & Trim(UniqueNum) & "_Main.pdf"
fn = Replace(fn,"/","-")
fn = Replace(fn,":","-")
...
If IncludeIndividuals ="T" Then
	...
	If not rsIncludeIndividuals.eof then
		...
		Do while not rsIncludeIndividuals.EOF
			...
			ImpVar = baseURL & "accountsreceivable/reports/consolidatedInvUnpaid/consolidated_stmt_indv_color_PDFgen.asp?i=" & IvsSeq 
			ImpVar = ImpVar & "&un=" & Session("UserNo")
...
<h1 class="page-header"><i class="fa fa-file-text"></i>  Consolidated Invoice Unpaid (Account)</h1>
<!-- row !-->
<div class="row" style="margin-top:20px;">

    <!-- START !-->
    	
    	<p><a href="#" class="title">Save, Email or Post Unpaid Consolidated Invoice</a></p>
    	...
    	<div class="row" style="margin-top:15px;">
	    	...
	    	<div class="col-md-2 pull-left">
	    		<button type="button" class="btn btn-primary" id="btnSaveAndPostConsolidatedInvoice"><i class="fa fa-floppy-o" aria-hidden="true"></i>&nbsp;Save &amp; <i class="fa fa-upload" aria-hidden="true"></i>&nbsp;Post Unpaid Invoice</button>
	    	</div>
    	...
    	<div class="row" style="margin-top:20px;">
	    	...
	    	<div class="col-md-2 pull-left">
	    		<button type="button" class="btn btn-primary" id="btnSaveConsolidatedInvoice"><i class="fa fa-floppy-o" aria-hidden="true"></i>&nbsp;Save Unpaid Invoice Only</button>
	    	</div>
    	...
    	<div class="row" style="margin-top:20px;">
	    	...
	    	<div class="col-md-2 pull-left">
	    		<button type="button" data-target="#consolidatedInvoiceEmailModal" data-toggle="modal" class="btn btn-primary"><i class="fa fa-envelope" aria-hidden="true"></i>&nbsp;Email Unpaid Invoice</button>	    	
	    	</div>
	...
	<div class="modal-dialog" role="document">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<input type="hidden" name="txtPaidOrUnpaid" id="txtPaidOrUnpaid" value="UNPAID">
...
ConsolidatedStatementinclude file="../../../inc/footer-main.asp"-->