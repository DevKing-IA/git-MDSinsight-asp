		      ...
		      url:'omitInvoice.asp',
		          data:{ivshistsequence: ivshistsequence},
					success: function(msg){
						window.location = "consolidated_stmt_frm_acct.asp";
					}
		 });
		  }
	}
...
Description = MUV_Read("DisplayName") & " ran the report: #2 - Consolidated Invoice (Unpaid Only) for " & GetTerm("account") & " # " & Account 
	...
	<table width="100%" cellpadding="0" cellspacing="0">
		...
		<table width="100%" cellpadding="0" cellspacing="0" id="general-table-margin">
							...
							<% 'Now get the actual invoice data
								...
								SQLInvoices = SQLInvoices & "AND IvsTotalAmt - PaidAmt > 0 AND IvsHistSequence NOT IN (Select IvsHistSequence from zReportConsolidatedInvoiceOmit_" & Trim(Session("userNo")) & ") "
