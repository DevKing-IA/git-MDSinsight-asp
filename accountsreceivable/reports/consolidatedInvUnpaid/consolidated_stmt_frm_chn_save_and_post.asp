...
<%
	...
	'**************************************************************************************************
		...
		SQLInvoicesSingle = SQLInvoicesSingle & "IvsTotalAmt - PaidAmt > 0 AND IvsHistSequence IN (SELECT IvsHistSequence FROM zReportConsolidatedInvoiceInclude_" & Trim(UserNo) & ") "
