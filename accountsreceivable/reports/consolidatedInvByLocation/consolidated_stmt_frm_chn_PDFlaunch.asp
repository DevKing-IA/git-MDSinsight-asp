...
ImpVar = baseURL & "accountsreceivable/reports/consolidatedInvByLocation/consolidated_stmt_frm_chn_PDFgen.asp?s=" & Replace(StartDate,"/","~") & "&e=" & Replace(EndDate,"/","~")& "&c=" & Account
...
<h1 class="page-header"><i class="fa fa-file-text"></i>  Consolidated Invoice By Location (Chain)</h1>
<!-- row !-->
