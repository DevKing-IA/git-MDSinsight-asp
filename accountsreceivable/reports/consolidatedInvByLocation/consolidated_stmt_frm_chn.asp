...
Description = MUV_Read("DisplayName") & " ran the report: #4 - Consolidated Invoice By Location for chain # " & Chain 
	...
	<table width="100%" cellpadding="0" cellspacing="0">
				...
				<!-- eof logo  / address !-->			
	 			...
	 			<th scope="col" width="30%">
		 			...
		 			<table width="100%" class="consolidated-invoice-number-date-account">
			 			<tbody>
				 			<tr>
					 			...
					 			<th scope="col" width="30%" align="right"><strong><% Response.Write(Trim(Chain) & Trim(Replace(EndDate,"/",""))) %></strong></th>
				 			</tr>
			 			</tbody>
		 			</table>
		 			...
		 			<table width="100%" class="consolidated-invoice-number-date-account">
			 			<tbody>				 			
				 			<tr>
					 			<th scope="col" width="40%"><strong>Chain Number:</strong></th>
					 			<th scope="col" width="60%" align="right"><strong><%= Chain %></strong></th>
				 			</tr>
			 			</tbody>
		 			</table>
		...
		<table width="100%" cellpadding="0" cellspacing="0" id="general-table-margin">
								...
								If HeldCust <> rsInvoices("CustNum") Then
									...
									%>
										...
										<tr class="tr-lines" style="background-color:#FFFF99;border:1px gray solid;">
											<th scope="col" colspan="5" align="right" class="invoice-date"><strong>Subtotal <%=FormatCurrency(ChainSubtotal)%></strong></th>
										</tr>
				...
				%>
					...
					<tr>
						<th colspan="5" style="height:50px;">&nbsp;</th>
					<tr>
				<%
