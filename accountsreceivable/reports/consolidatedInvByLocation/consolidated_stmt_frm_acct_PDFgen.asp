...
If Recordset.recordcount <= 0 then
	...
	%>MDS Insight: Unable to connect to SQL database. The server is not available or the credentials specified are incorrect. - Consolidated Invoice By Location from Account Report<%
	Response.End
Else
			...
			<% 'Now get the actual invoice data
						...
						Do While NOT rsInvoices.EOF
							...
							If HeldCust <> rsInvoices("CustNum") Then
								...
								If AccountSubtotal <> 0 Then ' not on the first one but print the subtotals
									...
									totalSubtotal = totalSubtotal + AccountSubtotal
								
								%>
									<tr style="font-size:16px;line-height:40px;" bgcolor="#FFFF99" border="3" bordercolor="#000">
										<th scope="col" colspan="5" align="right" style="font-weight:bold;" valign="middle"><strong>Subtotal <%=FormatCurrency(AccountSubtotal)%></strong></th>
									</tr>
									<tr><th colspan="5" style="height:50px;">&nbsp;</th><tr>
									<% AccountSubtotal = 0
								End If%>
									<tr style="font-size:16px;line-height:40px;" bgcolor="#ADD8E6" border="3" bordercolor="#000">
										<th scope="col" colspan="5" class="invoice-date" align="center" valign="middle"><strong>ACCOUNT #<%= rsInvoices("CustNum") %>&nbsp;&nbsp;<%= CustName %></strong></th>
									</tr>
									<tr style="font-size:16px;line-height:40px;" bgcolor="#ADD8E6" border="3" bordercolor="#000">
										<th scope="col" colspan="5" class="invoice-date" align="center" valign="middle"><strong><%= Address1 %>&nbsp;&nbsp;<%= Address2 %>&nbsp;&nbsp;<%= City %></strong></th>
									</tr>
								...
								SQLGetInvoicesInDateRange = SQLGetInvoicesInDateRange & "AND CustNum = '" & Account & "' "
				...
				%>
					<tr style="font-size:16px;" bgcolor="#FFFF99">
						<th scope="col" colspan="5" align="right" style="font-weight:bold;" valign="middle" height="40"><strong>Subtotal <%=FormatCurrency(AccountSubtotal)%></strong></th>
					</tr>
					<tr>
