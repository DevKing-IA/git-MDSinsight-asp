...
<!--
    function validateCustomizeForm()
    {
    	var WebOrderOrMDSInvoiceFilter = $("#selWebOrderOrMDSInvoiceFilter option:selected").val();
 	    var ocsPeriodStartValue = document.frmWebFulfillInvXRef_Customize.selPeriodStart.value;
	    var ocsPeriodEndValue = document.frmWebFulfillInvXRef_Customize.selPeriodEnd.value;
	    	
   	
    	if (WebOrderOrMDSInvoiceFilter == "" && (ocsPeriodStartValue !== "" || ocsPeriodEndValue !== "")) 				
    	{		
			swal("Please select to filter by OCS Web Order Date or MDS Invoice Date.")
			return false;
		}
    		   		
    	//If they chose the option button for invoice or web order filtering, make sure they selected 2 periods
		if (WebOrderOrMDSInvoiceFilter !== "")
		{
	    	// Start period empty
...
Else
	...
	ReportSpecificData1  = "OCS"
	ReportSpecificData2  = "Periods"
	ReportSpecificData3  = StartPeriodBeingEvaluatedCustomize
	ReportSpecificData4  = EndPeriodBeingEvaluatedCustomize
	ReportSpecificData8  = "true"
	ReportSpecificData9  = "true"
	ReportSpecificData10  = "true"
	ReportSpecificData11  = "true"
	ReportSpecificData12  = "false"
...
<div class="modal fade bs-example-modal-lg-customize" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-lg modal-height">
		<div class="modal-content">
			...
			<form method="post" action="WebFulfillmentInvoiceXRefSummaryByPeriod_Customize_SaveValues.asp" name="frmWebFulfillInvXRef_Customize" id="frmWebFulfillInvXRef_Customize" onsubmit="return validateCustomizeForm();">
