...
If rs.EOF Then
	SQL = "INSERT INTO Settings_Reports (ReportNumber, UserNo) VALUES (1800, " & Session("userNo") & ")"
	rs.Close
	Set rs= cnn8.Execute(SQL)
End If
...
SQL = SQL & "WHERE ReportNumber = 1800 AND UserNo = " & Session("userNo")
...
Response.Redirect ("WebFulfillmentInvoiceXRefSummaryByCust.asp")
%>
