...
If rs.EOF Then
	SQL = "INSERT INTO Settings_Reports (ReportNumber, UserNo) VALUES (1700, " & Session("userNo") & ")"
	rs.Close
	Set rs= cnn8.Execute(SQL)
End If
...
SQL = SQL & "WHERE ReportNumber = 1700 AND UserNo = " & Session("userNo")
...
Response.Redirect ("WebFulfillmentInvoiceXRefSummary.asp")
%>
