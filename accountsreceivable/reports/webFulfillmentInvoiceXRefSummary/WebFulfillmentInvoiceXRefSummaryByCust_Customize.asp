...
<div class="modal fade bs-example-modal-lg-customize" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-lg modal-height">
		<div class="modal-content">
			...
			<form method="post" action="WebFulfillmentInvoiceXRefSummaryByCust_Customize_SaveValues.asp" name="frmWebFulfillInvXRef_Customize" id="frmWebFulfillInvXRef_Customize" onsubmit="return validateCustomizeForm();">
