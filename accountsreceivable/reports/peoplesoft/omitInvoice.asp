<%
'Make entires of invoice #s to skip in zExportPeopleSoftInvoiceOmit_
...
If ivshistsequence <> "" Then 
	...
	SQLTmpTable = "INSERT INTO zExportPeopleSoftInvoiceOmit_" & Trim(Session("UserNo")) & " (IvsHistSequence) VALUES ('" & IvsHistSequence & "')"	
