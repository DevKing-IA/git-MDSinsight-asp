...
{
    document.frmconsolidatedInvDetail.action ="consolidated_InvDetail_frm_acct.asp";
...
<h1 class="page-header"><i class="fa fa-file-text"></i> Detailed Consolidated Invoice</h1>


<form method="POST" name="frmconsolidatedInvDetail" id="frmconsolidatedInvDetail" onsubmit="return OnSubmitForm();">		    
    ...
    <div class="col-lg-6">
	    ...
	    <div class="col-box">
		    ...
		    <div class="row account-chain row-line">
			    ...
			    <div class="col-lg-2">
				     <h4><%=GetTerm("Account")%></h4>
	 		    </div>
	    		    
			    <div class="col-lg-5">Please search for a <%=GetTerm("customer")%> in the box below
	        		<!-- select company !-->
