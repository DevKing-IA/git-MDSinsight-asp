...
If InternalRecordIdentifier <> "" Then
	...
	Description = "The " & GetTerm("Accounts Receivable") & " contact title named " & ContactTitle & " was deleted by " & GetUserDisplayNameByUserNo(Session("UserNo")) 
	CreateAuditLogEntry GetTerm("Accounts Receivable") & " contact title deleted",GetTerm("Accounts Receivable") & " contact title deleted","Major",0,Description
