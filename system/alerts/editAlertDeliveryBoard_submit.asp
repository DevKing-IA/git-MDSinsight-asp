...
End If
If cint(Orig_TimeOfDay) <> cint(TimeOfDay) Then
	Description = Description & "  Time Of Day changed from " & Orig_TimeOfDay  & " to " & TimeOfDay
End If
...
Response.Redirect("main.asp#DeliveryBoardAlerts")
