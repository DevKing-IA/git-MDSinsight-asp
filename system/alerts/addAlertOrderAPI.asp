...
<h1 class="page-header"><i class="fa fa-fw fa-exclamation"></i>New Order API Alert</h1>


<form method="POST" action="addAlertOrderAPI_submit.asp"  onsubmit="return checkform();" name="frmAddAlert" id="frmAddAlert" class="uk-form bt-flabels js-flabels" >
	...
	<div class="row row-line">
		...
		<div class="col-lg-3">
			<select class="form-control when-line" name="selCond" id="selCond" onchange="cndChanged();">
				...
				<option value="Order Contains Driver Notes">An Order is received containing Driver Notes</option>
				<option value="Order Contains Warehouse Notes">An Order is received containing Warehouse Notes</option>
				<option value="RA Contains Driver Notes">An RA is received containing Driver Notes</option>
				<option value="RA Contains Warehouse Notes">An RA is received containing Warehouse Notes</option>
				<option value="RA Contains RA Notes">An RA is received containing RA Notes</option>
			</select>
		</div>
		<!-- eof when select !-->
