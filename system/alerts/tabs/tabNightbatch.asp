 <% If MUV_READ("nightBatchModuleOn") = "Enabled" Then %>
			<div role="tabpanel" class="tab-pane fade in" id="NightBatchAlerts"> 
				<br>
				<div class="row">
				 	<div class="col-lg-12">
					 	<p>
							 <a href="addAlertNightBatch.asp">
						    	<button type="button" class="btn btn-success">Add New Night Batch Alert</button>
							</a>
					 	</p>
				 	</div>
				</div>
				...
				<div class="table-responsive">
		            <table    class="table table-striped table-condensed table-hover sortable">
		              ...
		              <tbody>
						...
						SQL = "SELECT * FROM SC_Alerts Where AlertType='NightBatch' order by AlertName"
						...
						If not rs.EOF Then
					        ...
					        %>
								...
								<tr>
									<td>
										<a href='editAlertNightBatch.asp?a=<%= rs.Fields("InternalAlertRecNumber")%>'><%= rs.Fields("AlertName")%></a></td>
										<td><%
											Select Case Ucase(rs.Fields("Condition"))
												Case "START"
													Response.Write("Night Batch Starts")
												Case "FINISH"
													Response.Write("Night Batch Finishes")
												Case "RUNNING"
													Response.Write("Night Batch has been running longer than " & rs.Fields("NBMinutes") & " minutes")
												Case "LOG"
													Response.Write("Night Batch Log received")
											End Select
										%>
										</td>		
										<td>
									...
									<td>
							   		...
							   		<td><a href='deleteAlertQues.asp?a=<%=rs.Fields("InternalAlertRecNumber")%>&tab=NightBatchAlerts'><i class="fas fa-trash-alt"></i></a></td>
