...
If Request.Form("chkPrimarySalesperson") = "on" then PrimarySalesperson = 1 Else PrimarySalesperson = 0
If Request.Form("chkSecondrySalesperson") = "on" then SecondrySalesperson = 1 Else SecondrySalesperson = 0
...
SQL = SQL & "AdditionalEmails,EmailVerbiage,Enabled ,TextToUserNos,AdditionalText,TextVerbiage,NBLimitMiniutes,NBLimitMaxTimes,NotificationType,PublicOrPrivate,CreatedByUserNo,EmailPrimarySls,EmailSecondarySls)"
SQL = SQL &  " VALUES (" 
SQL = SQL & "'ServiceElapsed'"
SQL = SQL & ",'" & AlertName & "'"
SQL = SQL & ",'" & Condition & "'"
SQL = SQL & ","  & Minutes & ""
SQL = SQL & ",'" & Emailto & "'"
...
SQL = SQL & "," & PrimarySalesperson 
SQL = SQL & "," & SecondrySalesperson & ")"
