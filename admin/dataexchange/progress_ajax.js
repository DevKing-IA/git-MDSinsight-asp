...
{ 
	...
	{ 	
		...
		var strFormat = "<table><tr><td colspan=2><table style=\"width: 500px; border: 1pt black solid;\"><tr><td>" +
						"<table style=\"height: 35px; background-color:#F88; width:" + PercentComplete + "%;\"><tr><td></td></tr></table>" +
						"</td></tr></table></td></tr><tr style=\"font:family: arial; font-size: 15pt;\">";
