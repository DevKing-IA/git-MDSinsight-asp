   ...
   <% If MUV_Read("equipmentModuleOn") = "Enabled" Then %>
		<!-- userAccessInvControl line !-->
	   	<div class="col-xs-6 col-sm-1 col-md-1 col-lg-4 enable-disable">
			...
			<input type="checkbox" id="chkUserCanEditEqpTablesOnFly"  name="chkUserCanEditEqpTablesOnFly" <% If userCanEditEqpTablesOnFly = True OR userCanEditEqpTablesOnFly = 1 Then Response.Write("checked")%>>
