...
<h1 class="page-header"><i class="fa fa-lightbulb-o "></i>&nbsp;Need To Know Report Settings
...
<div class="container tile-container">
  ...
  <div class="row">
    ...
    <% If MUV_READ("orderAPIModuleOn") <> "Hidden" Then %>
	    <a href="<%= BaseURL %>admin/global/tiles/needtoknow/order-api.asp"><div class="col-sm-2">
	      <div class="tile pink">
    ...
    <% If cint(MUV_Read("arModuleOn")) = 1 Then %>
	    <a href="<%= BaseURL %>admin/global/tiles/needtoknow/accounts-receivable.asp"><div class="col-sm-2">
	      <div class="tile kellygreen">
	        <h3 class="title"><i class="fas fa-fw fa-file-invoice-dollar"></i>&nbsp;<%= GetTerm("Accounts Receivable") %></h3>
	        <p>&nbsp;</p>
	      </div>
	    </div></a> 
	<% Else %>
    ...
    <% If MUV_Read("equipmentModuleOn")  <> "Hidden" Then %>
	    <a href="<%= BaseURL %>admin/global/tiles/needtoknow/equipment.asp"><div class="col-sm-2">
	      <div class="tile teal">
	...
	<% Else %>
	    <a href="#"><div class="col-sm-2">
	      <div class="tile teal disabled">
	        <h3 class="title"><i class="fa fa-coffee"></i>&nbsp;Equipment</h3>
	        <p>This module is currently disabled.</p>
	      </div>
	    </div></a> 	
	<% End If %>
    ...
    <a href="<%= BaseURL %>admin/global/tiles/needtoknow/global-settings.asp"><div class="col-sm-2">
      <div class="tile blue">
        <h3 class="title"><i class="fa fa-globe"></i>&nbsp;Global Settings</h3>
        <p>&nbsp;</p>
      </div>
    </div></a>
	
     <% If MUV_Read("InventoryControlModuleOn")  <> "Hidden" Then %>
	    <a href="<%= BaseURL %>admin/global/tiles/needtoknow/inventory.asp"><div class="col-sm-2">
