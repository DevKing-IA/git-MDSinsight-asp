...
<script>
	...
	$(document).ready(function() {
		...
		$('#modalGlobalSettingsNeedToKnowReportScheduler').on('show.bs.modal', function(e) {
	    	...
	    	$.ajax({
				...
				cache: false,
				data: "action=GetContentForGlobalSettingsN2KReportScheduler",
				success: function(response)
				 {
	               	 $modal.find('#modalGlobalSettingsNeedToKnowReportSchedulerContent').html(response);               	 
	             },
	             failure: function(response)
				 {
				  	$modal.find('#modalGlobalSettingsNeedToKnowReportSchedulerContent').html("Failed");
        ...
        $('#modalN2KGlobalSettingsEmailAddressesToCC').on('show.bs.modal', function (e) {
            var $modal = $(this);
        });
...
<%
	...
	If not rs.EOF Then
		N2KGlobalSettingsEmailToUserNos = rs("N2KGlobalSettingsEmailToUserNos")
		N2KGlobalSettingsUserNosToCC = rs("N2KGlobalSettingsUserNosToCC")
		N2KGlobalSettingsEmailAddressesToCC = rs("N2KGlobalSettingsEmailAddressesToCC")
		N2KGlobalSettingsReportONOFF = rs("N2KGlobalSettingsReportONOFF")
		N2KGlobalIncludeMissingClientLogoFile = rs("N2KGlobalIncludeMissingClientLogoFile")
		N2KGlobalIncludeMissingHolidayinCompanyCalendar = rs("N2KGlobalIncludeMissingHolidayinCompanyCalendar")
	End If
...
<h1 class="page-header"><i class="fa fa-globe"></i>&nbsp;Need To Know - Global Settings 
...
<form method="post" action="<%= BaseURL %>admin/global/tiles/needtoknow/global-settings-submit.asp" name="frmN2KGlobalSettings" id="frmN2KGlobalSettings">
	...
	<div class="container">
		...
		<div class="row">
			<h3><i class="fad fa-sliders-h"></i>&nbsp;Global Settings Need To Know Report General Settings</h3>
		</div>
					    ...
					    <div class="row">
				            ...
				            <div class="col-lg-12 line-full">
								...
								<p><strong>Check off each section to be included in the Need to Know report</strong></p>
									...
									<%
										If N2KGlobalIncludeMissingClientLogoFile = 0 Then
											MissingClientLogoFile = ""
										Else
											MissingClientLogoFile = "checked"
										End If
		
										If N2KGlobalIncludeMissingHolidayinCompanyCalendar = 0 Then
											MissingHolidayinCompanyCalendar = ""
										Else
											MissingHolidayinCompanyCalendar = "checked"
										End If
									%>
									...
									<tr>
									<td>
										<input type="checkbox" id="chkMissingClientLogoFile" name="chkMissingClientLogoFile" <%=MissingClientLogoFile%>>&nbsp;&nbsp;Missing Client Logo File
									</td>
									<td>
										<input type="checkbox" id="chkMissingHolidayinCompanyCalendar" name="chkMissingHolidayinCompanyCalendar" <%=MissingHolidayinCompanyCalendar%>>&nbsp;&nbsp;Missing Holiday in Company Calendar
									</td>
									</tr>
									</table>
		...
		<div class="row">
			<h3><i class="fad fa-file-pdf"></i>&nbsp;Global Settings Need To Know Report Settings</h3>
		</div>
	
		<div class="row">
		
			<div class="col-md-4">
				<% If N2KGlobalSettingsReportONOFF = 0 Then %>
					<div class="panel panel-danger">
						<div class="panel-heading">
							<h3 class="panel-title">Global Settings Need To Know Report (OFF)</h3>
							<span class="pull-right clickable panel-collapsed"><i class="glyphicon glyphicon-chevron-down"></i></span> 
						</div>
				<% Else %>
					<div class="panel panel-success">
						<div class="panel-heading">
							<h3 class="panel-title">Global Settings Need To Know Report (ON)</h3>
							<span class="pull-right clickable panel-collapsed"><i class="glyphicon glyphicon-chevron-down"></i></span> 
						</div>				
				<% End If %>
					<div class="panel-body">
					    ...
					    <div class="row">
				            ...
				            <div class="col-lg-12 line-full">
					      		...
					      		<%
					      		If N2KGlobalSettingsReportONOFF = 0 Then
									Response.Write("<input type='checkbox' id='chkN2KGlobalSettingsReportONOFF' name='chkN2KGlobalSettingsReportONOFF'")
								Else
									Response.Write("<input type='checkbox' id='chkN2KGlobalSettingsReportONOFF' name='chkN2KGlobalSettingsReportONOFF' checked")
								End If
								Response.Write(">")
								%>
				            </div>
								...
								<div class="text-element circles-list">
									<ol>
										<li>
											...
											<button type="button" class="btn btn-primary" data-toggle="modal" data-show="true" href="#" data-target="#modalGlobalSettingsNeedToKnowReportScheduler" data-tooltip="true" data-title="Global Settings Need To Know Report Scheduler" style="cursor:pointer;"><i class="far fa-calendar-alt"></i> Global Settings Need To Know Report Scheduler</button>
										</li>
										<li>
											<p>Select users <i class="fad fa-user-friends"></i> to send the report to:</p>
											<input type="hidden" name="lstSelectedN2KAPIEmailToUserNos" id="lstSelectedN2KAPIEmailToUserNos" value="<%= N2KGlobalSettingsEmailToUserNos %>">
										...
										<li>
											...
											<button type="button" class="btn btn-primary" data-toggle="modal" data-show="true" href="#" data-target="#modalN2KGlobalSettingsEmailAddressesToCC" data-tooltip="true" data-title="Additional emails" style="cursor:pointer;"><i class="fas fa-at"></i> Add Additional Emails To CC</button>						
				             				<% If N2KGlobalSettingsEmailAddressesToCC <> "" Then %>
				             					<p style="margin-top:20px;"><strong>Current Additional CC Emails:</strong> <%= N2KGlobalSettingsEmailAddressesToCC %></p>
				             				<% End If %>
										</li>
										<li>
											<p>Select additonal users <i class="fad fa-user-friends"></i> to CC the report to:</p>
											<p><small>&nbsp;(CC:'s will receive a separate email for each recipient of this report)</small></p>
											<input type="hidden" name="lstSelectedN2KAPIUserNosToCC" id="lstSelectedN2KAPIUserNosToCC" value="<%= N2KGlobalSettingsUserNosToCC %>">
...
<!-- pencil Modal -->
<div class="modal fade" id="modalGlobalSettingsNeedToKnowReportScheduler" tabindex="-1" role="dialog" aria-labelledby="modalGlobalSettingsNeedToKnowReportSchedulerLabel">
	...
	<div class="modal-dialog" role="document">
		...
		<div class="modal-content">	
		    ...
		    <div class="modal-header">
		        ...
		        <h4 class="modal-title" id="titleGlobalSettingsNeedToKnowReportSchedulerLabel">Global Settings Need To Know Report Generation Scheduler</h4>
		    </div>

			<form name="frmEditGlobalSettingsNeedToKnowReportSchedulerModal" id="frmEditGlobalSettingsNeedToKnowReportSchedulerModal" action="global-settings-n2k-report-scheduler-submit.asp" method="POST">

				<div class="modal-body">
				    
					<div id="modalGlobalSettingsNeedToKnowReportSchedulerContent">
						<!-- Content for the modal will be generated and written here -->
						<!-- Content generated by Sub GetContentForGlobalSettingsNeedToKnowReportScheduler() in InSightFuncs_AjaxForAdminTimepickerModals.asp -->
					</div>
				...
				<div class="modal-footer">
					...
					<button type="submit" id="btnGlobalSettingsNeedToKnowReportScheduleSave" class="btn btn-primary">Save Schedule Changes</button>
				</div>
...
<div class="modal fade" id="modalN2KGlobalSettingsEmailAddressesToCC" tabindex="-1" role="dialog" aria-labelledby="modalN2KGlobalSettingsEmailAddressesToCCLabel">
	...
	<div class="modal-dialog" role="document">
		...
		<div class="modal-content">	
			...
			<form  name="frmEditUsersList" id="Form5" action="users-list-update-needtoknow.asp" method="POST">
                <input type="hidden" name="userListName" value="N2KGlobalSettingsEmailAddressesToCC" />
				<div class="modal-body">
				    
					<div id="Div2">
				    <textarea class="form-control email-alert-line" rows="5" id="Textarea1" name="txtN2KGlobalSettingsEmailAddressesToCC"><%= N2KGlobalSettingsEmailAddressesToCC %></textarea>
