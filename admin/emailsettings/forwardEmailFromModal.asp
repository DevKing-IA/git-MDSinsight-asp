...
<div class="custom-container">
	...
	<form method="POST" action="forwardEmailFromModal_Submit.asp" name="frmForwardEmailAddresses" id="frmForwardEmailAddresses" onsubmit="return validateForwardEmailForm();">
		...
		<div class="row row-line pull-left">
			...
			<div class="form-group col-lg-12">
    			...
    			<div class="col-sm-9">
    				...
    				<input type="hidden" name="txtCategory1Active" id="txtCategory1Active" value="<%= currentEmailCategory1ViewedID %>">
