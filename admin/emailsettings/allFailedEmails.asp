...
<script language="javascript">
	...
	$(document).ready(function() {
	    ...
	    $("[id^='myEmailModal']").on('hidden.bs.modal', function () {
	        ...
	        window.location.href = "allFailedEmails.asp?cat1ID=" + cat1 + "#" + cat2;
	    });
	    ...
	    $('#resendBtn').click(function() {
				...
				$.ajax({		
					...
					success: function (data) {
						...
						window.location.href = "allFailedEmails.asp?cat1ID=" + cat1 + "#" + cat2 + "&cid=" + clientid;
					}
				})	
...
<h1 class="page-header"><i class="fa fa-envelope-o"></i> All Failed Emails</h1>


<div class="container-full">
    <div class="row">
        <div class="inbox-head">
          <h3>Sent Items That Failed</h3>
      </div>

        <div class="col-sm-3 col-md-2">
            <div class="btn-group">
                <button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown">
                    All Failed Mail <span class="caret"></span>
                </button>
    ...
    <div class="row">
        <div class="col-sm-3 col-md-2">
			...
			<%       
				...
				SQL_SentEmail = "SELECT COUNT(EmailCategory1) as catCount,EmailCategory1 FROM SC_EmailLog  WHERE ASPMailStatus <> 'Sent Successfully' AND Archived <> 1 GROUP BY EmailCategory1 ORDER BY EmailCategory1"
        ...
        <div class="col-sm-9 col-md-10">
        	...
        	<form method="post" action="allFailedEmails.asp" name="frmAllSentEmails" id="frmAllSentEmails">
            ...
            <%
				...
				If  currentEmailCategory1ViewedIDTab = "" Then 
					SQL_SentEmail = "SELECT EmailCategory2 FROM SC_EmailLog WHERE EmailCategory1 = '" &  DefView & "' AND ASPMailStatus <> 'Sent Successfully' AND Archived <> 1 GROUP BY EmailCategory2 ORDER BY EmailCategory2"
				Else
					SQL_SentEmail = "SELECT EmailCategory2 FROM SC_EmailLog WHERE EmailCategory1 = '" & currentEmailCategory1ViewedIDTab & "' AND ASPMailStatus <> 'Sent Successfully' AND Archived <> 1 GROUP BY EmailCategory2 ORDER BY EmailCategory2"
				End IF
            ...
            <%
				...
				If  currentEmailCategory1ViewedIDTab = "" Then 
					SQL_SentEmail = "SELECT * FROM SC_EmailLog WHERE EmailCategory1 = '" & DefView & "' AND ASPMailStatus <> 'Sent Successfully' AND Archived <> 1 ORDER BY EmailCategory2, EmailDate DESC, EmailTime DESC"
				Else
					SQL_SentEmail = "SELECT * FROM SC_EmailLog WHERE EmailCategory1 = '" & currentEmailCategory1ViewedIDTab & "' AND ASPMailStatus <> 'Sent Successfully' AND Archived <> 1  ORDER BY EmailCategory2, EmailDate DESC, EmailTime DESC"		
				End IF
