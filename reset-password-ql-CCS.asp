...
<%
	...
	If QuickUserNo = "" AND QuickClientID = "" Then
...
<html lang="en">
  <head>
	...
	<% If QuickClientID = "1071" OR QuickClientID = "1071d" Then %>
...
%>
	...
	<!-- logo !-->
    <div class="container">
    	<img src="<%= BaseURL %>/clientFiles/<%= QuickClientID %>/loginPage/img/logo.png" class="img-responsive" alt="<%= CompanyName %>" title="<%= CompanyName %>">
    </div>
    <!-- eof logo !-->
 ...
 <!-- login box !-->
    ...
    <div class="login-container">
    	...
    	<form action="<%= BaseURL %>reset-password-ql-CCS.asp?action=captcha" method="POST" name="frmPasswordReset" id="frmPasswordReset" onSubmit="return checkFormWithCaptcha();" class="form-signin">
      

			<input type="hidden" name="txtclientkey" id="txtclientkey" value="<%= QuickClientID %>"> 
	        ...
	        <a href="<%= BaseURL %>ql-CCS.asp?u=<%= QuickUserNo %>&c=<%= QuickClientID  %>"><button type="button">Nevermind, return to login</button></a>
