	       ...
	       //Navigation Menu Slider
			...
			$('#lstExistingRegionList').multiselect({
				   buttonTitle: function(options, select) {
					...
					buttonClass: 'btn btn-primary multiselectheight',
					buttonWidth: '500px',
					maxHeight: 400,
					dropRight:true,
    ...
    <div class="navbar-header pull-right">
	    <div class="row">
				...
				<div class="col-lg-8 text-center" style="margin-top:20px">    
					<h2 style="display:inline;word-wrap: break-word;color:<%= FSBoardKioskGlobalTitleTextFontColor %>"><%= FSBoardKioskGlobalTitleText %></h2>
				</div>	
			...
			<div class="row">	            
				...
				<div class="col-lg-12" style="text-align:center;background-color: #DCE6E9;">    
			  		...
			  		<div style="padding-top:2px;margin-left:0px">
			  			...
			  			<% If userCanAccessServiceDispatchCenter(Session("UserNo")) = true Then %>
							<div class="col-lg-1" style="margin-left:10px">
								<a href="dispatchcenter/main.asp">
									<button type="button" class="btn btn-warning btn-lg"><i class="fas fa-headset"></i>&nbsp;Dispatch Center</button>
								</a>
							</div>
						<% End If %>
						...
						<% If FilterChangeModuleOn() Then %>
							...
							<div class="col-lg-1" style="margin-left:15px">
								<a href="main.asp">
									<button type="button" class="btn btn-success btn-lg"><i class="fas fa-ballot-check"></i>&nbsp;Service Tickets</button>
								</a>
							</div>
						
							<div class="col-lg-1" style="margin-right:10px; margin-left:-25px">
								<a href="<%= baseURL %>service/filters/main.asp">
									<button type="button" class="btn btn-lg buttonFilterChangeIndicatorAndButtonColor"><i class="fas fa-filter"></i>&nbsp;Filters</button>
								</a>
							</div>							
						...
						<% End If %>
					 	...
					 	<div class="col-lg-6">
							...
							<select id="lstExistingRegionList" multiple="multiple" name="lstExistingRegionList">
								...
								SQLRegionList = "SELECT * FROM AR_Regions WHERE UseRegionForServiceTickets = 1 ORDER BY InternalRecordIdentifier"
								...
								Else
									'***********************************************************************
									'No Regions Were Checked to Show Service Tickets, So Show All Regions
									'***********************************************************************
									
									Set cnnRegionListAll = Server.CreateObject("ADODB.Connection")
									cnnRegionListAll.open Session("ClientCnnString")
						
									SQLRegionListAll = "SELECT * FROM AR_Regions ORDER BY InternalRecordIdentifier"
									
									Set rsRegionListAll = Server.CreateObject("ADODB.Recordset")
									rsRegionListAll.CursorLocation = 3 
									Set rsRegionListAll = cnnRegionListAll.Execute(SQLRegionListAll)
									
									If Not rsRegionListAll.EOF Then
										Do While Not rsRegionListAll.EOF
										
											RegionName = rsRegionListAll("Region")
											Response.Write("<option value='" & rsRegionListAll("InternalRecordIdentifier") & "'>" & RegionName & "</option>")
									
											rsRegionListAll.MoveNext
										Loop
									End If
									
									Set rsRegionListAll = Nothing
									cnnRegionListAll.Close
									Set cnnRegionListAll = Nothing
							...
							<button type="button" class="btn btn-danger btn-lg" data-toggle="collapse" data-target="#btn-accord-danger"><i class="fas fa-key"></i>&nbsp;Legend</button>
							<!-- Collapsible Content -->
							<div class="collapse" id="btn-accord-danger">
								...
								<div class="row">      
							        ...
							        <div class="col-lg-6">
							        	<div class="legend-dispatch-acknowledged">
							            	<h4>Dispatch <%= GetTerm("Acknowledged") %></h4>
							            </div>
							        </div>
					...
					<div class="col-lg-4 pull-right" style="margin-top:-50px; margin-right:40px;">    
				  		<div class="pause">
