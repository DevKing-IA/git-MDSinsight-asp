...
'Sub GetProspectExportInformationForModal()
...
'Sub CheckIfContactTitleAlreadyExists()
'***************************************************
...
Select Case action
	...
	Case "GetProspectExportInformationForModal"
		GetProspectExportInformationForModal()
	...
	Case "CheckIfContactTitleAlreadyExists"
		CheckIfContactTitleAlreadyExists()
...
Sub GetProspectExportInformationForModal()
	...
	<div class="form-group">
		<div class="col-lg-12" style="padding-left:0px; margin-bottom:15px;">
			<label class="control-label" style="padding-left:0px;">You have selected the following prospect(s) to export:</label>
		</div>
		<div class="col-lg-12">
	...
	For i = 0 to uBound(ProspectIDArray)
		...
		SQLExport = "SELECT * FROM PR_Prospects WHERE InternalRecordIdentifier = " & ProspectIDNumber 		
		...
		If NOT rsExport.EOF Then
			Company = rsExport("Company")
			Suite= rsExport("Floor_Suite_Room__c")
			Street= rsExport("Street")
			City= rsExport("City")
...
%>
	...
	<div class="col-lg-12" style="padding-left:0px; margin-top:15px;">
		<label class="control-label" style="padding-left:0px;">Click the exprt button below to export these prospect(s).</label>
	</div>
...
Sub CheckIfContactTitleAlreadyExists()
	...
	passedNewContactTitle = Request.Form("passedNewContactTitle")
	passedCurrContactTitle = Request.Form("passedCurrContactTitle")
	
	If passedNewContactTitle  <> passedCurrContactTitle Then
		
		SQLCheckForDuplicateContactTitle = "SELECT * FROM PR_ContactTitles WHERE ContactTitle = '" & passedNewContactTitle & "'"
			
		Set cnnCheckForDuplicateContactTitle = Server.CreateObject("ADODB.Connection")
		cnnCheckForDuplicateContactTitle.open(Session("ClientCnnString"))
		Set rsCheckForDuplicateContactTitle = Server.CreateObject("ADODB.Recordset")
		rsCheckForDuplicateContactTitle.CursorLocation = 3 
		
		Set rsCheckForDuplicateContactTitle = cnnCheckForDuplicateContactTitle.Execute(SQLCheckForDuplicateContactTitle)
	
		If NOT rsCheckForDuplicateContactTitle.EOF Then
			Response.Write("CONTACTTITLEALREADYEXISTS")
		Else
			Response.Write("CONTACTTITLENOTINUSE")
		End If
			
		Set rsCheckForDuplicateContactTitle = Nothing
		cnnCheckForDuplicateContactTitle.Close
		Set cnnCheckForDuplicateContactTitle = Nothing
		
	Else
	
		Response.Write("CONTACTTITLENOTCHANGED")
