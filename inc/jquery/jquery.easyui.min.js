...
r[name]();   
//custom logic
if (($('.selectedCategory'))&&($('.selectedCategory').parent())&&($('.selectedCategory').parent().parent())){
	$('#tt1').tree("select", $('.selectedCategory').parent().parent());
}
if ($('#collapseBtn')){
	$('#collapseBtn').click(function(){$('#tt1').tree('collapseAll');});
	$('#expandBtn').click(function(){$('#tt1').tree('expandAll');});
}
//end custom logic
}else{
