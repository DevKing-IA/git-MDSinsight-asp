...
SQL = "Update Settings_Reports Set ReportSpecificData1 = '" & columnsDataSQL & "' WHERE ReportNumber = 1400 AND UserNo = " & Session("userNo") & " AND PoolForProspecting = 'Won' AND UserReportName = 'Current'"
Set rs= cnn8.Execute(SQL)
...
Set cnn8 = Nothing
	...
	%>
<form id="frmSetColumnView" name="frmSetColumnView" method="POST" action="mainWonPool.asp">
