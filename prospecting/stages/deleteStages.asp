...
If InternalRecordIdentifier <> "" Then
	...
	SQLDelete = "Select * FROM PR_STages WHERE InternalRecordIdentifier = "& InternalRecordIdentifier 
	...
	If not rsDelete.Eof Then StagesDescription = rsDelete("Stage")
	...
	SQLDelete = "Delete FROM PR_Stages WHERE InternalRecordIdentifier = "& InternalRecordIdentifier 
