...
If InternalRecordIdentifier <> "" Then
	...
	SQLDelete = "Select * FROM PR_Reasons WHERE InternalRecordIdentifier = "& InternalRecordIdentifier 
	...
	If not rsDelete.Eof Then Reason = rsDelete("Reason")
	...
	SQLDelete = "Delete FROM PR_Reasons WHERE InternalRecordIdentifier = "& InternalRecordIdentifier 
	...
	Description = "The " & GetTerm("Prospecting") & " reason named " & Reason & " was deleted by " & GetUserDisplayNameByUserNo(Session("UserNo")) 
