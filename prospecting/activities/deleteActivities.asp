...
If InternalRecordIdentifier <> "" Then
	...
	SQLDelete = "Select * FROM PR_Activities WHERE InternalRecordIdentifier = "& InternalRecordIdentifier 
	...
	If not rsDelete.Eof Then Activity = rsDelete("Activity")
	...
	SQLDelete = "Delete FROM PR_Activities WHERE InternalRecordIdentifier = "& InternalRecordIdentifier 
	...
	Description = "The " & GetTerm("Prospecting") & " activity named " & Activity & " was deleted by " & GetUserDisplayNameByUserNo(Session("UserNo")) 
