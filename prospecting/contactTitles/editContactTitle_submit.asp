...
If Orig_ContactTitle  <> ContactTitle  Then
	Description = Description & GetTerm("Prospecting") & " contact title changed from " & Orig_ContactTitle & " to " & ContactTitle
End If

CreateAuditLogEntry GetTerm("Prospecting") & " contact title edited",GetTerm("Prospecting") & " contact title edited","Minor",0,Description
