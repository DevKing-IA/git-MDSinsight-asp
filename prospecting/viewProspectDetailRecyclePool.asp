...
If InternalRecordIdentifier = "" Then Response.Redirect("mainRecyclePool.asp")
OpenTabNum = 1 'Dfault open tab #
OpenTabNum = Request.QueryString("t") 

Description = GetUserDisplayNameByUserNo(Session("UserNo")) & " viewed the " & GetTerm("Recycle Pool") & " prospect, <strong>" & GetProspectNameByNumber(InternalRecordIdentifier) & "</strong>."
	...
	<div class="page-header">
		...
		<div class="col-lg-3">
			...
			<%	If GetCRMPermissionLevel(Session("userNo")) = "READWRITE" Then %>
				<a class="btn btn-success btn-lg btn-block" href="recycleInactiveProspect.asp?i=<%= InternalRecordIdentifier %>" role="button" style="margin-top:15px;"><i class="fa fa-recycle"></i> &nbsp;<%= GetTerm("Recycle") %> This Prospect</a>
			<% End If %>
 
			<a class="btn btn-primary btn-lg btn-block" href="mainRecyclePool.asp" role="button" style="margin-top:15px;"><i class="fa fa-arrow-left"></i> &nbsp;Back To <%= GetTerm("Recycle Pool") %></a>
		...
		<div class="col-lg-3">
            ...
            <div class="quick-info-block CRMTileActivityColor">
                ...
                <hr class="tile">
                <p><%= GetTerm("Prospects") %> do not have a next activity in the <%= GetTerm("recycle pool") %>.</p>
            </div>
		...
		<div class="col-lg-12">
			<div class="bottom-tabs-section">
				...
				<ul class="nav nav-tabs" role="tablist">
					...
					<!--<li role='presentation'><a href="mainRecyclePool.asp" class="btn btn-secondary active" role="button" aria-pressed="true"><span class="return">Back To <%= GetTerm("Prospecting") %> Main</span></a></li>-->
				</ul>
				<!-- eof tab navigation -->
