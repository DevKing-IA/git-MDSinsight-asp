...
If reportNameToDelete <> "" Then
	...
	SQLDeleteFilter = "DELETE FROM Settings_Reports WHERE ReportNumber = 1400 AND UserNo = " & Session("userNo") & " AND PoolForProspecting = 'Dead' AND UserReportName = '" & reportNameToDeleteSQL & "'"
	...
	Description = GetUserDisplayNameByUserNo(Session("Userno")) & " deleted the " & GetTerm("Prospecting") & "  " & GetTerm("Recycle Pool") & "filter view named, " & reportNameToDeleteSQL
