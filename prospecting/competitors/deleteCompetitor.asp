...
If InternalRecordIdentifier <> "" Then
	...
	SQLDelete = "Select * FROM PR_Competitors WHERE InternalRecordIdentifier = "& InternalRecordIdentifier 
	...
	If not rsDelete.Eof Then Competitor = rsDelete("CompetitorName")
	...
	SQLDelete = "Delete FROM PR_Competitors WHERE InternalRecordIdentifier = "& InternalRecordIdentifier 
	...
	Description = "The " & GetTerm("Prospecting") & " Competitor named " & Competitor & " was deleted by " & GetUserDisplayNameByUserNo(Session("UserNo")) 
