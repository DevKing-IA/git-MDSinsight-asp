...
<!--#include file="mainWonPoolModalCustomizeDataFilterValues.asp"-->
...
<div class="modal fade bs-modal-show-hide-columns-won-pool" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
...
<div class="modal-content">
  ...
  <div class="modal-header">
	...
	<form method="post" action="mainWonPoolCustomizeSaveShowHideColumnValues.asp" name="frmProspectingCustomizeColumnsWonPool">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
         <a href="#" onClick="document.frmProspectingCustomizeColumnsWonPool.submit()"><button type="button" class="btn btn-primary">Save Show/Hide Columns</button></a>     
      </div>
      </form>
    </div>
  </div>
...
<!------------------------------------------------------------------------------>	
		...
		<div class="modal fade" id="myProspectingDeleteModal" tabindex="-1" role="dialog" aria-labelledby="myProspectingDeleteLabel">
		  <div class="modal-dialog" role="document">
		    <div class="modal-content">
		      ...
		      <form name="frmDeleteProspects" id="frmDeleteProspects" method="post" action="deleteWonPoolProspectsFromModal.asp">
	...
	<!-- new prospect group modal starts here !-->
	<!-- modal starts here !-->
		<div class="modal fade" id="saveAsNewProspectFilterViewWonPool" tabindex="-1" role="dialog" aria-labelledby="saveAsNewProspectFilterViewWonPool">
		  <div class="modal-dialog" role="document">
				...
				<!--
				   ...
				   function validateViewNameWonPool()
				    {
		    ...
		    <div class="modal-content">
		      ...
		      <form name="frmCreateNewFilterReportViewWonPool" id="frmCreateNewFilterReportViewWonPool">
			      <div class="modal-body">
						...
						<div class="form-group">
							<label class="col-sm-12 control-label" style="margin-left:-15px;">Save This View As:</label>
					      	...
					      	CurrentViewNameForSQL = Replace(MUV_READ("CRMVIEWSTATE"),"'","''")
					  	  	...
					  	  	SQL = "SELECT * FROM Settings_Reports WHERE ReportNumber = 1400 AND UserNo = " & Session("userNo") & " AND PoolForProspecting = 'Won' "
			      ...
			      <div class="modal-footer">
			        <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
			        <button type="button" class="btn btn-primary" onclick="if (validateViewNameWonPool()) saveAsNewProspectFilterViewWonPool();" id="saveFilterReportViewNameButton">Save Filter View</button>
			      </div>
		      </form>
		    </div>
		  </div>
	...
	<!-- new prospect group modal starts here !-->
	<!-- modal starts here !-->
		<div class="modal fade" id="editFilterViewNameWonPool" tabindex="-1" role="dialog" aria-labelledby="editFilterViewNameWonPool">
		  <div class="modal-dialog" role="document">
				...
				<!--
				   ...
				   function validateEditViewNameWonPool()
				    {
								    				       
					   var viewName = $("#txtUpdatedFilterReportViewNameWonPool").val();
		    ...
		    <div class="modal-content">
		      ...
		      <form name="frmEditFilterViewNameWonPool" id="frmEditFilterViewNameWonPool">
			      <div class="modal-body">
	
					<div class="col-lg-12">
						<div class="form-group">
							<label class="col-sm-12 control-label" style="margin-left:-15px;">Save This View As:</label>
							<% CurrentViewName = MUV_READ("CRMVIEWSTATEWONPOOL") %>
							
							<input type="text" class="form-control required" id="txtUpdatedFilterReportViewNameWonPool" name="txtUpdatedFilterReportViewNameWonPool">
							
							<input type="hidden" name="originalViewNameWonPool" id="originalViewNameWonPool" value="<%= CurrentViewName %>">
			      ...
			      <div class="modal-footer">
			        <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
			        <button type="button" class="btn btn-primary" onclick="if (validateEditViewNameWonPool()) renameProspectFilterViewWonPool();" id="updateFilterReportViewNameButton">Update Filter Name</button>
			      </div>
		      </form>
		    </div>
		  </div>
	...
	<!-- delete prospect view modal starts here !-->	
		<div class="modal fade" id="deleteProspectViewWonPool" tabindex="-1" role="dialog" aria-labelledby="myProspectingWonLabel">
		  <div class="modal-dialog" role="document">
		    <div class="modal-content">
		      <div class="modal-header">
				...
				<form name="frmDeleteProspectViewWonPool" id="frmDeleteProspectViewWonPool" method="post" action="deleteWonPoolProspectFilterViewFromModal.asp">
					...
					<div class="modal-footer">
						...
						<button type="button" class="btn btn-success" onclick="frmDeleteProspectViewWonPool.submit()"><span class="glyphicon glyphicon-ok-sign"></span> Yes, Delete This View</button>
					</div>
	...
	<!-- won prospect modal starts here !-->
	<!-- modal starts here !-->
		<div class="modal fade" id="myProspectingWonModal" tabindex="-1" role="dialog" aria-labelledby="myProspectingWonLabel">
		  <div class="modal-dialog" role="document">
		    <div class="modal-content">
		      <div class="modal-header">
		        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
		        <h4 class="modal-title" id="myProspectingWonModalLabel">Won This Prospect</h4>
		      </div>
		      <form name="frmProspectWon" id="frmProspectWon">
			      <div class="modal-body">
	
					<div class="col-lg-12">
						<div class="form-group">
							<label class="col-sm-12 control-label">Some Fields Here</label>
							<input type="text" class="form-control required" id="txtProspectWon" name="txtProspectWon">
						</div>
					</div>
			      ...
			      <div class="modal-footer">
			        <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
			        <button type="button" class="btn btn-primary" data-dismiss="modal">Won Prospect</button>
			      </div>
		      </form>
		    </div>
		  </div>
