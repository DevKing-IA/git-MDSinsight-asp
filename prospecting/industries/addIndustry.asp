...
<h1 class="page-header"> Add New Industry</h1>

<div class="custom-container">

	<form method="POST" action="addIndustry_submit.asp" name="frmAddIndustry" id="frmAddIndustry" onsubmit="return validateIndustryForm();">
		...
		<div class="row row-line">
			...
			<div class="form-group col-lg-12">
    			...
    			<div class="col-sm-6">
    				<input type="text" class="form-control required" id="txtIndustry" name="txtIndustry" >
    			</div>
			</div>
