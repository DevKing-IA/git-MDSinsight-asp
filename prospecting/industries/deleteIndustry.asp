...
If InternalRecordIdentifier <> "" Then
	...
	SQLDelete = "Select * FROM PR_Industries WHERE InternalRecordIdentifier = "& InternalRecordIdentifier 
	...
	If not rsDelete.Eof Then Industry = rsDelete("Industry")
	...
	SQLDelete = "Delete FROM PR_Industries WHERE InternalRecordIdentifier = "& InternalRecordIdentifier 
	...
	Description = "The " & GetTerm("Prospecting") & " industry named " & Industry & " was deleted by " & GetUserDisplayNameByUserNo(Session("UserNo")) 
