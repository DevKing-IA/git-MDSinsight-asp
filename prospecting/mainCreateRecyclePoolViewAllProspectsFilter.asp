...
SQL = "SELECT * FROM Settings_Reports WHERE ReportNumber = 1400 AND UserNo = " & Session("userNo") & " AND PoolForProspecting = 'Dead' AND UserReportName = 'All Prospects'"
...
If rs.EOF Then
	SQL = "INSERT INTO Settings_Reports (ReportNumber, UserNo, PoolForProspecting, UserReportName) Values (1400, " & Session("userNo") & ",'Dead','All Prospects')"
	rs.Close
	Set rs= cnn8.Execute(SQL)
End If
...
SQL = SQL & " WHERE ReportNumber = 1400 AND UserNo = " & Session("userNo") & " AND PoolForProspecting = 'Dead' AND UserReportName = 'All Prospects'"
Set rs= cnn8.Execute(SQL)
...
<form id="frmCreateAllProspectsView" name="frmCreateAllProspectsView" method="POST" action="mainRecyclePool.asp">
