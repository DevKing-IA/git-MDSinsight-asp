...
<h1 class="page-header"><i class="fa fa-fw fa-asterisk"></i> <%= GetTerm("Prospecting") %> Dashboard</h1>
	...
	<hr>
			...
			<table class="table">	
				...
				<%
				If SelectedUserNumbersToDisplay <> "" Then
					SQLProspectSalesRep = "SELECT tblUsers.userNo, COUNT(PR_Prospects.CreatedByUserNo) AS SalesRepCount"
					SQLProspectSalesRep = SQLProspectSalesRep & " FROM  tblUsers INNER JOIN"
				...
				Else
					...
					SQLProspectSalesRep = SQLProspectSalesRep & " FROM  tblUsers INNER JOIN"
					SQLProspectSalesRep = SQLProspectSalesRep & " PR_Prospects ON PR_Prospects.CreatedByUserNo = tblUsers.userNo"
					SQLProspectSalesRep = SQLProspectSalesRep & " WHERE PR_Prospects.CreatedDate >= '" & mondayOfLastWeek & "' AND PR_Prospects.CreatedDate < '" & mondayOfThisWeek & "' "
					SQLProspectSalesRep = SQLProspectSalesRep & " GROUP BY tblUsers.userNo"
					SQLProspectSalesRep = SQLProspectSalesRep & " ORDER BY SalesRepCount DESC"
				End If
			...
			<table class="table">	
				...
				SQLProspectLeadSource = SQLProspectLeadSource & " FROM  PR_LeadSources INNER JOIN"
	...
	<hr>
			...
			<table class="table">	
				...
				<%
					...
					SQLAppmtCompleteSalesRep = SQLAppmtCompleteSalesRep & " FROM  tblUsers INNER JOIN"
			...
			<table class="table">	
				...
				SQLAppmtCompleteLeadSource = SQLAppmtCompleteLeadSource & " FROM  PR_LeadSources INNER JOIN"
	...
	<hr>
			...
			<table class="table">	
				...
				SQLNewClientsBySalesRep = SQLNewClientsBySalesRep & " FROM tblUsers INNER JOIN"
	...
	<hr>
			...
			<table class="table">	
				...
				SQLQualifiedClientsBySalesRep = SQLQualifiedClientsBySalesRep & " FROM tblUsers INNER JOIN"
